...
commit ; 
insert into ___.input_output values ('dessableurdegraisseur', array['prod_e', 'd_vie', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'eh', 'lavage', 'conc', 'vit', 'tauenterre', 'e', 'h', 'abatdco', 'abatngl', 'qe', 'dco', 'ntk', 'dbo5', 'mes', 'tgraisses', 'tsables', 'vu', 'welec']::varchar[], array['qe_s', 'ngl_s', 'dco_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 construction degazage 2', 'CO2 exploitation dessableurdegraisseur 1', 'CO2 exploitation intrant mbbr 6', 'CO2 exploitation dessableurdegraisseur 3', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3', 'CO2 construction dessableurdegraisseur 1']::varchar[]) ;

create sequence ___.dessableurdegraisseur_bloc_name_seq ;     

create type ___.prod_e_type as enum ('Oxygène liquide', 'Sable de filtration', 'Bisulfite de sodium', 'Acide nitrique', 'Permanganate de potassium', 'Acide phosphorique', 'Sulfate de sodium', 'Acide chlorhydrique', 'Méthanol', 'Acide citrique', 'Acide sulfurique', 'Chaux', 'Chlore', 'Cristaux de soude', 'Résine anionique', 'Résine échangeuse d’ions', 'Urée', 'Antiscalants', 'Régénérant de calcium', 'Éthanol', 'Carbonate de calcium', 'Soude', 'Antimousse', 'Calcium neuf', 'Sulfate d’aluminium', 'Peroxyde d’hydrogène', 'Résine cationique', 'Floculant', 'Poudre de calcium', 'Chlorate de sodium');
...
select api.add_new_formula('CO2 exploitation bassin_dorage 3'::varchar, 'co2_e=feelec*dbo5elim*w_dbo5_eau'::varchar, 3, ''::text) ;
select api.add_new_formula('tbentrant clarificateur 1'::varchar, 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)'::varchar, 1, ''::text) ;
select api.add_new_formula('dco_s dessableurdegraisseur 3'::varchar, 'dco_s=dco*(1 - abatdco)'::varchar, 3, ''::text) ;
select api.add_new_formula('ngl_s dessableurdegraisseur 3'::varchar, 'ngl_s=eh*ntk_eh*(1 - abatngl)'::varchar, 3, ''::text) ;
...
select api.add_new_formula('CO2 exploitation intrant mbbr 6'::varchar, 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)'::varchar, 6, ''::text) ;
...
select api.add_new_formula('ngl_s dessableurdegraisseur 3'::varchar, 'ngl_s=ntk*(1 - abatngl)'::varchar, 3, ''::text) ;
select api.add_new_formula('tbentrant digesteur__methaniseur 2'::varchar, 'tbentrant=0.0005*nbjour*(dbo5 + mes)'::varchar, 2, ''::text) ;
select api.add_new_formula('dco_s dessableurdegraisseur 3'::varchar, 'dco_s=eh*dco_eh*(1 - abatdco)'::varchar, 3, ''::text) ;
...
commit ; 
insert into ___.input_output values ('usine', array['d_vie', 'eh', 'welec', 'qe', 'dbo5', 'mes']::varchar[], array[]::varchar[], array['tbentrant clarificateur 1', 'CO2 construction usine 1', 'CO2 construction usine 2', 'CO2 elec 6', 'CO2 exploitation usine 2', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation usine 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=eh*fetraitement_c*nbjour*qe_eh/d_vie', 'co2_c=fetraitement_c*nbjour*qe/d_vie', 'co2_e=feelec*welec', 'co2_e=fetraitement_e*nbjour*qe', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=eh*fetraitement_e*nbjour*qe_eh']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction usine 1', 'CO2 construction usine 2', 'CO2 elec 6', 'CO2 exploitation usine 2', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation usine 1']::varchar[],
...
commit ; 
insert into ___.input_output values ('centrifugeuse_pour_deshy', array['d_vie', 'direct', 'tbsortant', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction centrifugeuse_pour_deshy 2', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction centrifugeuse_pour_deshy 3', 'CO2 construction centrifugeuse_pour_deshy 1', 'CO2 elec 6', 'CO2 exploitation centrifugeuse_pour_deshy 3', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_cd)*(eh<10000)+(feobj50_cd)*(eh>10000)*(eh<100000)+(feobj100_cd)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_cd)*(eh<10000)+(feobj50_cd)*(eh>10000)*(eh<100000)+(feobj100_cd)*(eh>100000))*tbentrant', 'co2_c=((feobj10_cd)*(eh<10000)+(feobj50_cd)*(eh>10000)*(eh<100000)+(feobj100_cd)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_e=feelec*welec', 'co2_e=feelec*tbsortant*(-welec_cd*direct + welec_cd + welec_direct*direct)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction centrifugeuse_pour_deshy 2', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction centrifugeuse_pour_deshy 3', 'CO2 construction centrifugeuse_pour_deshy 1', 'CO2 elec 6', 'CO2 exploitation centrifugeuse_pour_deshy 3', 'tbentrant digesteur__methaniseur 2']::varchar[],
...
commit ; 
insert into ___.input_output values ('stockage_boue', array['d_vie', 'grand', 'dbo', 'aere', 'welec', 'eh', 'festock', 'dbo5', 'mes', 'tbentrant']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 exploitation stockage_boue 3', 'CO2 exploitation stockage_boue 2', 'CO2 construction stockage_boue 1', 'CO2 construction stockage_boue 3', 'CO2 elec 6', 'CH4 exploitation stockage_boue 2', 'CO2 construction stockage_boue 2', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation stockage_boue 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=fesilo_aere*tbentrant*aere', 'co2_e=0.0005*fesilo_aere*nbjour*aere*(dbo5 + mes)', 'co2_c=0.0005*eh*festock*nbjour*(dbo5_eh + mes_eh)', 'co2_c=festock*tbentrant', 'co2_e=feelec*welec', 'ch4_e=-dbo*(aere - 1)*(fesilo_grand*grand - fesilo_petit*(grand - 1))', 'co2_c=0.0005*festock*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=0.0005*eh*fesilo_aere*nbjour*aere*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 exploitation stockage_boue 3', 'CO2 exploitation stockage_boue 2', 'CO2 construction stockage_boue 1', 'CO2 construction stockage_boue 3', 'CO2 elec 6', 'CH4 exploitation stockage_boue 2', 'CO2 construction stockage_boue 2', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation stockage_boue 1']::varchar[],
...
commit ; 
insert into ___.input_output values ('conditionnement_chimique', array['d_vie', 'vboue', 'q_chaux', 'q_fecl3', 'q_anio', 'transp_fecl3', 'transp_catio', 'q_catio', 'transp_chaux', 'transp_anio', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 exploitation conditionnement_chimique 3', 'CO2 construction conditionnement_chimique 3', 'CO2 construction conditionnement_chimique 2', 'CO2 elec 6', 'CO2 construction conditionnement_chimique 1', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation intrant conditionnement_chimique 6']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=feelec*vboue*welec_cc', 'co2_c=((feobj10_cc)*(eh<10000)+(feobj50_cc)*(eh>10000)*(eh<100000)+(feobj100_cc)*(eh>100000))*tbentrant', 'co2_c=((feobj10_cc)*(eh<10000)+(feobj50_cc)*(eh>10000)*(eh<100000)+(feobj100_cc)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=feelec*welec', 'co2_c=((feobj10_cc)*(eh<10000)+(feobj50_cc)*(eh>10000)*(eh<100000)+(feobj100_cc)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=0.001*q_anio*(1000*feanionique + fetransp*transp_anio) + 0.001*q_catio*(1000*fecationique + fetransp*transp_catio) + 0.001*q_chaux*(1000*fechaux + fetransp*transp_chaux) + 0.001*q_fecl3*(1000*fefecl3 + fetransp*transp_fecl3)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 exploitation conditionnement_chimique 3', 'CO2 construction conditionnement_chimique 3', 'CO2 construction conditionnement_chimique 2', 'CO2 elec 6', 'CO2 construction conditionnement_chimique 1', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation intrant conditionnement_chimique 6']::varchar[],
d_vie real default 15::real,
vboue real,
q_chaux real,
q_fecl3 real,
...
commit ; 
insert into ___.input_output values ('centrifugeuse_pour_epais', array['d_vie', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction centrifugeuse_pour_epais 2', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction centrifugeuse_pour_epais 1', 'CO2 construction centrifugeuse_pour_epais 3', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_ce)*(eh<10000)+(feobj50_ce)*(eh>10000)*(eh<100000)+(feobj100_ce)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_ce)*(eh<10000)+(feobj50_ce)*(eh>10000)*(eh<100000)+(feobj100_ce)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_c=((feobj10_ce)*(eh<10000)+(feobj50_ce)*(eh>10000)*(eh<100000)+(feobj100_ce)*(eh>100000))*tbentrant', 'co2_e=feelec*welec', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction centrifugeuse_pour_epais 2', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction centrifugeuse_pour_epais 1', 'CO2 construction centrifugeuse_pour_epais 3', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2']::varchar[],
d_vie real default 15::real,
transp_poly real default 50::real,
q_poly real,
eh real,
...
commit ; 
insert into ___.input_output values ('filiere_eau', array['prod_e', 'd_vie', 'abatdco', 'eh', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'dco', 'ntk', 'dbo5', 'mes', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*dbo5elim*w_dbo5_eau', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'dco_s=dco*(1 - abatdco)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=eh*dco_eh*(1 - abatdco)']::varchar[],
formula_name varchar[] default array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[],
prod_e ___.prod_e_type not null default 'Oxygène liquide' references ___.prod_e_type_table(val),
d_vie real default 50::real,
abatdco real,
eh real,
...
commit ; 
insert into ___.input_output values ('chaulage', array['d_vie', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec', 'q_chaux', 'transp_chaux']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction chaulage 2', 'CO2 elec 6', 'CO2 construction chaulage 3', 'CO2 exploitation q_chaux chaulage 6', 'CO2 construction chaulage 1', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_ch)*(eh<10000)+(feobj50_ch)*(eh>10000)*(eh<100000)+(feobj100_ch)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=feelec*welec', 'co2_c=((feobj10_ch)*(eh<10000)+(feobj50_ch)*(eh>10000)*(eh<100000)+(feobj100_ch)*(eh>100000))*tbentrant', 'co2_e=0.001*q_chaux*(1000*fechaux + fetransp*transp_chaux)', 'co2_c=((feobj10_ch)*(eh<10000)+(feobj50_ch)*(eh>10000)*(eh<100000)+(feobj100_ch)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction chaulage 2', 'CO2 elec 6', 'CO2 construction chaulage 3', 'CO2 exploitation q_chaux chaulage 6', 'CO2 construction chaulage 1', 'tbentrant digesteur__methaniseur 2']::varchar[],
d_vie real default 15::real,
eh real,
dbo5 real,
mes real,
...
commit ; 
insert into ___.input_output values ('rejets', array['abatdco', 'eh', 'fech4_mil', 'abatngl', 'fen2o_oxi', 'dco', 'ngl']::varchar[], array[]::varchar[], array['CH4 exploitation rejets 1', 'CH4 exploitation rejets 2', 'N2O exploitation rejets 2', 'N2O exploitation rejets 1']::varchar[]) ;
...
formula varchar[] default array['ch4_e=eh*fech4_mil*dco_eh*(1 - abatdco)', 'ch4_e=dco*fech4_mil', 'n2o_e=fen2o_oxi*ngl', 'n2o_e=eh*fen2o_oxi*ntk_eh*(1 - abatngl)']::varchar[],
formula_name varchar[] default array['CH4 exploitation rejets 1', 'CH4 exploitation rejets 2', 'N2O exploitation rejets 2', 'N2O exploitation rejets 1']::varchar[],
...
commit ; 
insert into ___.input_output values ('bassin_cylindrique', array['tauenterre', 'vu', 'e', 'h']::varchar[], array[]::varchar[], array['CO2 construction bassin_cylindrique 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('digesteur__methaniseur', array['d_vie', 'tbsortant', 'tau_abattement', 'eh', 'dbo5', 'mes', 'vbiogaz', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 exploitation digesteur__methaniseur 3', 'CO2 construction digesteur__methaniseur 3', 'CO2 construction digesteur__methaniseur 4', 'tbsortant_s digesteur_aerobie 3', 'CH4 exploitation digesteur__methaniseur 3', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=feelec*tbsortant*welec_dan', 'co2_c=225*feobj_dan*tbsortant', 'co2_c=feobj_dan*vbiogaz', 'tbsortant_s=tbsortant*tau_abattement', 'ch4_e=tbsortant*tau_fuite*vol_ms', 'co2_e=feelec*welec', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 exploitation digesteur__methaniseur 3', 'CO2 construction digesteur__methaniseur 3', 'CO2 construction digesteur__methaniseur 4', 'tbsortant_s digesteur_aerobie 3', 'CH4 exploitation digesteur__methaniseur 3', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2']::varchar[],
d_vie real default 30::real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('voirie', array['ebit', 's']::varchar[], array[]::varchar[], array['CO2 construction voirie 2']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('degrilleur', array['d_vie', 'qdechet', 'eh', 'welec', 'munite_degrilleur', 'qmax', 'qe', 'dbo5', 'mes']::varchar[], array['qe_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 exploitation degrilleur 1', 'CO2 elec 6', 'CO2 construction degrilleur 1', 'CO2 construction degrilleur 2', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=eh*fedechet*qdechet*rhodechet', 'co2_e=feelec*welec', 'co2_c=eh*fepoids*munite_degrilleur*qe_eh/qmax', 'co2_c=fepoids*munite_degrilleur*qe/qmax', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 exploitation degrilleur 1', 'CO2 elec 6', 'CO2 construction degrilleur 1', 'CO2 construction degrilleur 2', 'tbentrant digesteur__methaniseur 2']::varchar[],
d_vie real default 15::real,
...
commit ; 
insert into ___.input_output values ('lagunage', array['prod_e', 'd_vie', 'abatdco', 'eh', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'dco', 'ntk', 'dbo5', 'mes', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('filtre_a_bande', array['d_vie', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction filtre_a_bande 2', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction filtre_a_bande 1', 'CO2 elec 6', 'CO2 construction filtre_a_bande 3', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_fb)*(eh<10000)+(feobj50_fb)*(eh>10000)*(eh<100000)+(feobj100_fb)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_fb)*(eh<10000)+(feobj50_fb)*(eh>10000)*(eh<100000)+(feobj100_fb)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_e=feelec*welec', 'co2_c=((feobj10_fb)*(eh<10000)+(feobj50_fb)*(eh>10000)*(eh<100000)+(feobj100_fb)*(eh>100000))*tbentrant', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction filtre_a_bande 2', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction filtre_a_bande 1', 'CO2 elec 6', 'CO2 construction filtre_a_bande 3', 'tbentrant digesteur__methaniseur 2']::varchar[],
d_vie real default 15::real,
transp_poly real default 50::real,
q_poly real,
eh real,
...
commit ; 
insert into ___.input_output values ('sechage_thermique', array['siccite_e', 'd_vie', 'eh', 'tbsortant', 'pelletisation', 'dbo5', 'mes', 'tbentrant', 'tee', 'welec']::varchar[], array['siccite_s', 'tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 exploitation sechage_thermique 3', 'CO2 exploitation sechage_thermique 4', 'CO2 construction sechage_thermique 1', 'CO2 elec 6', 'CO2 construction sechage_thermique 2', 'CO2 construction sechage_thermique 3', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=feelec*tbsortant*(24*nbjour*pth*(siccite_e - siccite_s) - welec_st_nopell*(pelletisation - 1) + welec_st_pell*pelletisation)', 'co2_e=feelec*(24*nbjour*pth*tee - tbsortant*(welec_st_nopell*(pelletisation - 1) - welec_st_pell*pelletisation))', 'co2_c=((feobj50_st)*(eh>10000)*(eh<100000)+(feobj100_st)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_e=feelec*welec', 'co2_c=((feobj50_st)*(eh>10000)*(eh<100000)+(feobj100_st)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj50_st)*(eh>10000)*(eh<100000)+(feobj100_st)*(eh>100000))*tbentrant', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 exploitation sechage_thermique 3', 'CO2 exploitation sechage_thermique 4', 'CO2 construction sechage_thermique 1', 'CO2 elec 6', 'CO2 construction sechage_thermique 2', 'CO2 construction sechage_thermique 3', 'tbentrant digesteur__methaniseur 2']::varchar[],
siccite_e real,
d_vie real default 15::real,
eh real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('compostage', array['d_vie', 'eh', 'tbsortant', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction compostage 1', 'tbentrant clarificateur 1', 'CO2 exploitation compostage 3', 'CH4 exploitation compostage 3', 'CO2 construction compostage 2', 'CO2 exploitation compostage 3', 'CO2 construction compostage 3', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2', 'N2O exploitation compostage 3']::varchar[]) ;
...
formula varchar[] default array['co2_c=0.0005*eh*fecompost*nbjour*(dbo5_eh + mes_eh)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=feelec*tbsortant*welec_compost', 'ch4_e=tbsortant*ch4_compost', 'co2_c=0.0005*fecompost*nbjour*(dbo5 + mes)', 'co2_e=fegazole*tbsortant*gazole_compost', 'co2_c=fecompost*tbentrant', 'co2_e=feelec*welec', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'n2o_e=tbsortant*n2o_compost']::varchar[],
formula_name varchar[] default array['CO2 construction compostage 1', 'tbentrant clarificateur 1', 'CO2 exploitation compostage 3', 'CH4 exploitation compostage 3', 'CO2 construction compostage 2', 'CO2 exploitation compostage 3', 'CO2 construction compostage 3', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2', 'N2O exploitation compostage 3']::varchar[],
...
commit ; 
insert into ___.input_output values ('tamis', array['d_vie', 'munite_tamis', 'eh', 'qmax', 'welec', 'compt', 'qe', 'dbo5', 'mes']::varchar[], array['qe_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 elec 6', 'CO2 exploitation tamis 1', 'tbentrant digesteur__methaniseur 2', 'CO2 construction tamis 2', 'CO2 construction tamis 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=feelec*welec', 'co2_e=eh*fedechet*rhodechet*(compt*qdechet_tamis_comp - qdechet_tamis_ncomp*(compt - 1))', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=fepoids*munite_tamis*qe/qmax', 'co2_c=eh*fepoids*munite_tamis*qe_eh/qmax']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 elec 6', 'CO2 exploitation tamis 1', 'tbentrant digesteur__methaniseur 2', 'CO2 construction tamis 2', 'CO2 construction tamis 1']::varchar[],
d_vie real default 15::real,
...
commit ; 
insert into ___.input_output values ('fpr', array['prod_e', 'd_vie', 'h', 'eh', 's_geom_eh', 'abatdco', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'dco', 'ntk', 'dbo5', 'mes', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 construction fpr 1', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*dbo5elim*w_dbo5_eau', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'dco_s=dco*(1 - abatdco)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_c=eh*s_geom_eh*(feevac*h*rhoterre + fegeom + fepelle*h*cad)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=eh*dco_eh*(1 - abatdco)']::varchar[],
formula_name varchar[] default array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 construction fpr 1', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[],
prod_e ___.prod_e_type not null default 'Oxygène liquide' references ___.prod_e_type_table(val),
d_vie real default 50::real,
...
commit ; 
insert into ___.input_output values ('conditionnement_thermiqu', array['d_vie', 'eh', 'vboue', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction conditionnement_thermiqu 1', 'CO2 construction conditionnement_thermiqu 2', 'CO2 construction conditionnement_thermiqu 3', 'CO2 elec 6', 'CO2 exploitation conditionnement_thermiqu 3', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj50_ct)*(eh>10000)*(eh<100000)+(feobj100_ct)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_c=((feobj50_ct)*(eh>10000)*(eh<100000)+(feobj100_ct)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj50_ct)*(eh>10000)*(eh<100000)+(feobj100_ct)*(eh>100000))*tbentrant', 'co2_e=feelec*welec', 'co2_e=feelec*vboue*welec_ct', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction conditionnement_thermiqu 1', 'CO2 construction conditionnement_thermiqu 2', 'CO2 construction conditionnement_thermiqu 3', 'CO2 elec 6', 'CO2 exploitation conditionnement_thermiqu 3', 'tbentrant digesteur__methaniseur 2']::varchar[],
d_vie real default 15::real,
eh real,
vboue real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('degazage', array['prod_e', 'd_vie', 'vit', 'tauenterre', 'e', 'eh', 'h', 'abatdco', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'qe', 'dco', 'ntk', 'dbo5', 'mes', 'vu', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 construction degazage 2', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3', 'CO2 construction dessableurdegraisseur 1']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*dbo5elim*w_dbo5_eau', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'dco_s=dco*(1 - abatdco)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_c=(febet*cad*e*rhobet*(3.14159*h*vit*(e + 5.52791*(qe/vit)**0.5) + 24*qe) + 24.0*fepelle*tauenterre*vit*(h + e)*(0.3618*e + (qe/vit)**0.5)**2 + 24.0*cad*vit*(0.3618*e + (qe/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(cad*vit)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (vu/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=eh*dco_eh*(1 - abatdco)', 'co2_c=(febet*cad*e*rhobet*(24*eh*qe_eh + 3.14159*h*vit*(e + 5.52791*(eh*qe_eh/vit)**0.5)) + 24.0*fepelle*tauenterre*vit*(h + e)*(0.3618*e + (eh*qe_eh/vit)**0.5)**2 + 24.0*cad*vit*(0.3618*e + (eh*qe_eh/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(cad*vit)']::varchar[],
formula_name varchar[] default array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 construction degazage 2', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3', 'CO2 construction dessableurdegraisseur 1']::varchar[],
prod_e ___.prod_e_type not null default 'Oxygène liquide' references ___.prod_e_type_table(val),
d_vie real default 50::real,
...
commit ; 
insert into ___.input_output values ('decanteur_lamellaire', array['prod_e', 'd_vie', 'abatdco', 'eh', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'dco', 'ntk', 'dbo5', 'mes', 'tauenterre', 'long', 'larg', 'e', 'h', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 construction decanteur_lamellaire 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*dbo5elim*w_dbo5_eau', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'dco_s=dco*(1 - abatdco)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_c=(fepelle*tauenterre*(h + e)*(e + larg)*(e + long) + cad*(febet*e*rhobet*(larg*long + 2*larg*(h + e) + 2*long*(h + e)) + feevac*rhoterre*tauenterre*(h + e)*(e + larg)*(e + long) + fefonda*(e + larg)*(e + long)))/cad', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=eh*dco_eh*(1 - abatdco)']::varchar[],
formula_name varchar[] default array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 construction decanteur_lamellaire 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[],
prod_e ___.prod_e_type not null default 'Oxygène liquide' references ___.prod_e_type_table(val),
d_vie real default 50::real,
abatdco real,
eh real,
...
commit ; 
insert into ___.input_output values ('sechage_solaire', array['siccite_e', 'd_vie', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['siccite_s', 'tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction sechage_solaire 1', 'CO2 elec 6', 'CO2 construction sechage_solaire 3', 'CO2 construction sechage_solaire 2', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj50_ss)*(eh>10000)*(eh<100000)+(feobj100_ss)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_e=feelec*welec', 'co2_c=((feobj50_ss)*(eh>10000)*(eh<100000)+(feobj100_ss)*(eh>100000))*tbentrant', 'co2_c=((feobj50_ss)*(eh>10000)*(eh<100000)+(feobj100_ss)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction sechage_solaire 1', 'CO2 elec 6', 'CO2 construction sechage_solaire 3', 'CO2 construction sechage_solaire 2', 'tbentrant digesteur__methaniseur 2']::varchar[],
siccite_e real,
d_vie real default 30::real,
eh real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('mbbr', array['prod_e', 'd_vie', 'smateriau', 'tau_remp', 's_v', 'tauenterre', 'e', 'h', 'abatdco', 'eh', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'dco', 'ntk', 'dbo5', 'mes', 'vu', 'welec']::varchar[], array['dbo5_s', 'ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'CO2 construction mbbr 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*dbo5elim*w_dbo5_eau', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'dco_s=dco*(1 - abatdco)', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*s_v*tau_remp*(e + 5.52791*(smateriau/(h*s_v*tau_remp))**0.5) + 24*smateriau) + 24.0*fepelle*h*s_v*tau_remp*tauenterre*(h + e)*(0.3618*e + (smateriau/(h*s_v*tau_remp))**0.5)**2 + 24.0*h*cad*s_v*tau_remp*(0.3618*e + (smateriau/(h*s_v*tau_remp))**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad*s_v*tau_remp)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (vu/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=eh*dco_eh*(1 - abatdco)']::varchar[],
formula_name varchar[] default array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'CO2 construction mbbr 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[],
prod_e ___.prod_e_type not null default 'Oxygène liquide' references ___.prod_e_type_table(val),
d_vie real default 50::real,
smateriau real,
...
commit ; 
insert into ___.input_output values ('tables_degouttage', array['d_vie', 'tbsortant', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction tables_degouttage 2', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 elec 6', 'CO2 construction tables_degouttage 3', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation tables_degouttage 3', 'CO2 construction tables_degouttage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_te)*(eh<10000)+(feobj50_te)*(eh>10000)*(eh<100000)+(feobj100_te)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_e=feelec*welec', 'co2_c=((feobj10_te)*(eh<10000)+(feobj50_te)*(eh>10000)*(eh<100000)+(feobj100_te)*(eh>100000))*tbentrant', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*tbsortant*welec_te', 'co2_c=((feobj10_te)*(eh<10000)+(feobj50_te)*(eh>10000)*(eh<100000)+(feobj100_te)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction tables_degouttage 2', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 elec 6', 'CO2 construction tables_degouttage 3', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation tables_degouttage 3', 'CO2 construction tables_degouttage 1']::varchar[],
d_vie real default 15::real,
tbsortant real,
transp_poly real default 50::real,
q_poly real,
...
commit ; 
insert into ___.input_output values ('flottateur', array['d_vie', 'tbsortant', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction flottateur 3', 'CO2 elec 6', 'CO2 exploitation flottateur 3', 'CO2 construction flottateur 2', 'CO2 construction flottateur 1', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_flot)*(eh<10000)+(feobj50_flot)*(eh>10000)*(eh<100000)+(feobj100_flot)*(eh>100000))*tbentrant', 'co2_e=feelec*welec', 'co2_e=feelec*tbsortant*welec_flot', 'co2_c=((feobj10_flot)*(eh<10000)+(feobj50_flot)*(eh>10000)*(eh<100000)+(feobj100_flot)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj10_flot)*(eh<10000)+(feobj50_flot)*(eh>10000)*(eh<100000)+(feobj100_flot)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction flottateur 3', 'CO2 elec 6', 'CO2 exploitation flottateur 3', 'CO2 construction flottateur 2', 'CO2 construction flottateur 1', 'tbentrant digesteur__methaniseur 2']::varchar[],
d_vie real default 30::real,
tbsortant real,
transp_poly real default 50::real,
q_poly real,
...
commit ; 
insert into ___.input_output values ('station_de_pompage', array['tauenterre', 'vu', 'e', 'h']::varchar[], array[]::varchar[], array['CO2 construction bassin_cylindrique 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('grilles_degouttage', array['d_vie', 'tbsortant', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction grilles_degouttage 3', 'CO2 elec 6', 'CO2 exploitation grilles_degouttage 3', 'CO2 construction grilles_degouttage 2', 'tbentrant digesteur__methaniseur 2', 'CO2 construction grilles_degouttage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_ge)*(eh<10000)+(feobj50_ge)*(eh>10000)*(eh<100000)+(feobj100_ge)*(eh>100000))*tbentrant', 'co2_e=feelec*welec', 'co2_e=feelec*tbsortant*welec_ge', 'co2_c=((feobj10_ge)*(eh<10000)+(feobj50_ge)*(eh>10000)*(eh<100000)+(feobj100_ge)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=((feobj10_ge)*(eh<10000)+(feobj50_ge)*(eh>10000)*(eh<100000)+(feobj100_ge)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 exploitation q_poly grilles_degouttage 6', 'CO2 construction grilles_degouttage 3', 'CO2 elec 6', 'CO2 exploitation grilles_degouttage 3', 'CO2 construction grilles_degouttage 2', 'tbentrant digesteur__methaniseur 2', 'CO2 construction grilles_degouttage 1']::varchar[],
d_vie real default 15::real,
tbsortant real,
transp_poly real default 50::real,
q_poly real,
...
commit ; 
insert into ___.input_output values ('digesteur_aerobie', array['d_vie', 'eh', 'tau_abattement', 'tbsortant', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction digesteur_aerobie 2', 'CO2 construction digesteur_aerobie 3', 'tbsortant_s digesteur_aerobie 3', 'CO2 construction digesteur_aerobie 1', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation digesteur_aerobie 3']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_da)*(eh<10000)+(feobj50_da)*(eh>10000)*(eh<100000)+(feobj100_da)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj10_da)*(eh<10000)+(feobj50_da)*(eh>10000)*(eh<100000)+(feobj100_da)*(eh>100000))*tbentrant', 'tbsortant_s=tbsortant*tau_abattement', 'co2_c=((feobj10_da)*(eh<10000)+(feobj50_da)*(eh>10000)*(eh<100000)+(feobj100_da)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_e=feelec*welec', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*tbsortant*welec_da']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction digesteur_aerobie 2', 'CO2 construction digesteur_aerobie 3', 'tbsortant_s digesteur_aerobie 3', 'CO2 construction digesteur_aerobie 1', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation digesteur_aerobie 3']::varchar[],
d_vie real default 30::real,
eh real,
...
commit ; 
insert into ___.input_output values ('filiere_boue', array['d_vie', 'eh', 'welec', 'dbo5', 'mes']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=feelec*welec', 'tbentrant=0.0005*nbjour*(dbo5 + mes)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 elec 6', 'tbentrant digesteur__methaniseur 2']::varchar[],
d_vie real default 15::real,
eh real,
welec real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('brm', array['prod_e', 'd_vie', 'tauenterre', 'vu', 'e', 'h', 'abatdco', 'eh', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'dco', 'ntk', 'dbo5', 'mes', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*dbo5elim*w_dbo5_eau', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'dco_s=dco*(1 - abatdco)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (vu/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=eh*dco_eh*(1 - abatdco)']::varchar[],
formula_name varchar[] default array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[],
prod_e ___.prod_e_type not null default 'Oxygène liquide' references ___.prod_e_type_table(val),
d_vie real default 50::real,
tauenterre real default 0.75::real,
vu real,
...
commit ; 
insert into ___.input_output values ('bassin_dorage', array['prod_e', 'd_vie', 'h', 'tauenterre', 'e', 'eh', 'tsejour', 'abatdco', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'qe', 'dco', 'ntk', 'dbo5', 'mes', 'vu', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'CO2 construction bassin_dorage 1', 'CO2 construction bassin_dorage 2', 'dco_s dessableurdegraisseur 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*dbo5elim*w_dbo5_eau', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'dco_s=dco*(1 - abatdco)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (vu/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=(febet*cad*e*rhobet*(24*eh*qe_eh*tsejour + 3.14159*h**2*(e + 5.52791*(eh*qe_eh*tsejour/h)**0.5)) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (eh*qe_eh*tsejour/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (eh*qe_eh*tsejour/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(qe*tsejour/h)**0.5) + 24*qe*tsejour) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (qe*tsejour/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (qe*tsejour/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'dco_s=eh*dco_eh*(1 - abatdco)']::varchar[],
formula_name varchar[] default array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'CO2 construction bassin_dorage 1', 'CO2 construction bassin_dorage 2', 'dco_s dessableurdegraisseur 3']::varchar[],
prod_e ___.prod_e_type not null default 'Oxygène liquide' references ___.prod_e_type_table(val),
d_vie real default 50::real,
h real default 4::real,
tauenterre real default 0.75::real,
...
commit ; 
insert into ___.input_output values ('clarificateur', array['prod_e', 'd_vie', 'tauenterre', 'vit', 'taur', 'e', 'eh', 'h', 'abatdco', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'qe', 'dco', 'ntk', 'dbo5', 'mes', 'vu', 'welec']::varchar[], array['tbentrant_s', 'ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'CO2 construction clarificateur 2', 'dco_s dessableurdegraisseur 3', 'CO2 construction clarificateur 1', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'dco_s dessableurdegraisseur 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('epaississement_statique', array['d_vie', 'eh', 'tbsortant', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction epaississement_statique 2', 'CO2 exploitation epaississement_statique 3', 'CO2 elec 6', 'CO2 construction epaississement_statique 1', 'tbentrant digesteur__methaniseur 2', 'CO2 construction epaississement_statique 3']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_es)*(eh<10000)+(feobj50_es)*(eh>10000)*(eh<100000)+(feobj100_es)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=feelec*tbsortant*welec_es', 'co2_e=feelec*welec', 'co2_c=((feobj10_es)*(eh<10000)+(feobj50_es)*(eh>10000)*(eh<100000)+(feobj100_es)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=((feobj10_es)*(eh<10000)+(feobj50_es)*(eh>10000)*(eh<100000)+(feobj100_es)*(eh>100000))*tbentrant']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction epaississement_statique 2', 'CO2 exploitation epaississement_statique 3', 'CO2 elec 6', 'CO2 construction epaississement_statique 1', 'tbentrant digesteur__methaniseur 2', 'CO2 construction epaississement_statique 3']::varchar[],
d_vie real default 30::real,
eh real,
tbsortant real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('filtre_a_presse', array['d_vie', 'transp_fecl3', 'q_chaux', 'q_poly', 'q_fecl3', 'transp_poly', 'transp_chaux', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant clarificateur 1', 'CO2 construction filtre_a_presse 3', 'CO2 elec 6', 'CO2 construction filtre_a_presse 2', 'CO2 construction filtre_a_presse 1', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation intrant filtre_a_presse 6']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_fp)*(eh<10000)+(feobj50_fp)*(eh>10000)*(eh<100000)+(feobj100_fp)*(eh>100000))*tbentrant', 'co2_e=feelec*welec', 'co2_c=((feobj10_fp)*(eh<10000)+(feobj50_fp)*(eh>10000)*(eh<100000)+(feobj100_fp)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj10_fp)*(eh<10000)+(feobj50_fp)*(eh>10000)*(eh<100000)+(feobj100_fp)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=fepolymere*q_poly + 0.001*fetransp*q_poly*transp_poly + 0.001*q_chaux*(1000*fechaux + fetransp*transp_chaux) + 0.001*q_fecl3*(1000*fefecl3 + fetransp*transp_fecl3)']::varchar[],
formula_name varchar[] default array['tbentrant clarificateur 1', 'CO2 construction filtre_a_presse 3', 'CO2 elec 6', 'CO2 construction filtre_a_presse 2', 'CO2 construction filtre_a_presse 1', 'tbentrant digesteur__methaniseur 2', 'CO2 exploitation intrant filtre_a_presse 6']::varchar[],
d_vie real default 15::real,
transp_fecl3 real,
q_chaux real,
q_poly real,
...
commit ; 
insert into ___.input_output values ('bassin_biologique', array['prod_e', 'd_vie', 'charge_bio', 'tauenterre', 'e', 'eh', 'h', 'abatdco', 'abatngl', 'w_dbo5_eau', 'dbo5elim', 'q_cl2', 'q_chaux', 'q_sulf_sod', 'q_mhetanol', 'q_ethanol', 'transp_hcl', 'q_citrique', 'q_ca_regen', 'q_ca_neuf', 'transp_ethanol', 'transp_uree', 'q_kmno4', 'transp_ca_poudre', 'q_sulf', 'transp_poly', 'q_rei', 'transp_chaux', 'transp_ca_regen', 'transp_sable_t', 'q_ca_poudre', 'q_anti_mousse', 'transp_citrique', 'transp_sulf', 'q_anio', 'q_hcl', 'q_soude_c', 'transp_nitrique', 'transp_rei', 'transp_nahso3', 'q_caco3', 'transp_phosphorique', 'transp_ca_neuf', 'transp_kmno4', 'q_h2o2', 'q_uree', 'transp_anio', 'transp_mhetanol', 'transp_sulf_sod', 'transp_naclo3', 'q_sulf_alu', 'transp_sulf_alu', 'transp_soude', 'q_naclo3', 'transp_oxyl', 'q_catio', 'transp_h2o2', 'q_nitrique', 'transp_caco3', 'transp_soude_c', 'q_sable_t', 'q_antiscalant', 'q_nahso3', 'q_soude', 'transp_anti_mousse', 'transp_antiscalant', 'transp_cl2', 'q_phosphorique', 'q_poly', 'transp_catio', 'q_oxyl', 'dbo5', 'dco', 'ntk', 'mes', 'vu', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'CO2 construction bassin_biologique 2', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'CO2 construction bassin_biologique 2', 'dco_s dessableurdegraisseur 3']::varchar[]) ;

create sequence ___.bassin_biologique_bloc_name_seq ;     

create type ___.charge_bio_type as enum ('Charge faible', 'Charge moyenne', 'Charge élevée');
...
formula varchar[] default array['co2_e=feelec*dbo5elim*w_dbo5_eau', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=(febet*cad*e*rhobet*(24*eh*dbo5_eh + 3.14159*h**2*charge_bio*(e + 5.52791*(eh*dbo5_eh/(h*charge_bio))**0.5)) + 24.0*fepelle*h*charge_bio*tauenterre*(h + e)*(0.3618*e + (eh*dbo5_eh/(h*charge_bio))**0.5)**2 + 24.0*h*cad*charge_bio*(0.3618*e + (eh*dbo5_eh/(h*charge_bio))**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad*charge_bio)', 'dco_s=dco*(1 - abatdco)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (vu/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=(febet*cad*e*rhobet*(24*dbo5 + 3.14159*h**2*charge_bio*(e + 5.52791*(dbo5/(h*charge_bio))**0.5)) + 24.0*fepelle*h*charge_bio*tauenterre*(h + e)*(0.3618*e + (dbo5/(h*charge_bio))**0.5)**2 + 24.0*h*cad*charge_bio*(0.3618*e + (dbo5/(h*charge_bio))**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad*charge_bio)', 'dco_s=eh*dco_eh*(1 - abatdco)']::varchar[],
formula_name varchar[] default array['CO2 exploitation bassin_dorage 3', 'tbentrant clarificateur 1', 'CO2 construction bassin_biologique 2', 'dco_s dessableurdegraisseur 3', 'ngl_s dessableurdegraisseur 3', 'CO2 exploitation intrant mbbr 6', 'CO2 elec 6', 'CO2 construction bassin_cylindrique 3', 'ngl_s dessableurdegraisseur 3', 'tbentrant digesteur__methaniseur 2', 'CO2 construction bassin_biologique 2', 'dco_s dessableurdegraisseur 3']::varchar[],
prod_e ___.prod_e_type not null default 'Oxygène liquide' references ___.prod_e_type_table(val),
d_vie real default 50::real,
