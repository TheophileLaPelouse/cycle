...
commit ; 
insert into ___.input_output values ('dessableurdegraisseur', array['prod_e', 'dbo5elim', 'w_dbo5_eau', 'lavage', 'conc', 'eh', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'tauenterre', 'vit', 'h', 'e', 'abatdco', 'abatngl', 'qe', 'dco', 'ntk', 'mes', 'dbo5', 'tsables', 'tgraisses', 'vu', 'welec']::varchar[], array['qe_s', 'ngl_s', 'dco_s']::varchar[], array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 construction bassin_cylindrique 3', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'CO2 construction degazage 2', 'CO2 exploitation dessableurdegraisseur 3', 'CO2 exploitation dessableurdegraisseur 1', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction dessableurdegraisseur 1', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;

create sequence ___.dessableurdegraisseur_bloc_name_seq ;     

create type ___.prod_e_type as enum ('Acide sulfurique', 'Permanganate de potassium', 'Chlore', 'Méthanol', 'Carbonate de calcium', 'Acide chlorhydrique', 'Urée', 'Peroxyde d’hydrogène', 'Résine cationique', 'Calcium neuf', 'Antiscalants', 'Cristaux de soude', 'Résine anionique', 'Acide nitrique', 'Antimousse', 'Sable de filtration', 'Chlorate de sodium', 'Acide phosphorique', 'Poudre de calcium', 'Acide citrique', 'Régénérant de calcium', 'Résine échangeuse d’ions', 'Chaux', 'Oxygène liquide', 'Éthanol', 'Floculant', 'Sulfate de sodium', 'Sulfate d’aluminium', 'Soude', 'Bisulfite de sodium');
...
select api.add_new_formula('ngl_s mbbr 3'::varchar, 'ngl_s=ntk*(1 - abatngl)'::varchar, 3, ''::text) ;
select api.add_new_formula('tbentrant centrifugeuse_pour_epais 2'::varchar, 'tbentrant=0.0005*nbjour*(dbo5 + mes)'::varchar, 2, ''::text) ;
...
select api.add_new_formula('ngl_s mbbr 3'::varchar, 'ngl_s=eh*ntk_eh*(1 - abatngl)'::varchar, 3, ''::text) ;
select api.add_new_formula('tbentrant compostage 1'::varchar, 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)'::varchar, 1, ''::text) ;
...
commit ; 
insert into ___.input_output values ('filtre_a_presse', array['transp_fecl3', 'transp_poly', 'q_chaux', 'transp_chaux', 'q_poly', 'q_fecl3', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction filtre_a_presse 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction filtre_a_presse 3', 'CO2 construction filtre_a_presse 1', 'CO2 exploitation intrant filtre_a_presse 6', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj10_fp)*(eh<10000)+(feobj50_fp)*(eh>10000)*(eh<100000)+(feobj100_fp)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_c=((feobj10_fp)*(eh<10000)+(feobj50_fp)*(eh>10000)*(eh<100000)+(feobj100_fp)*(eh>100000))*tbentrant', 'co2_c=((feobj10_fp)*(eh<10000)+(feobj50_fp)*(eh>10000)*(eh<100000)+(feobj100_fp)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_e=fepolymere*q_poly + 0.001*fetransp*q_poly*transp_poly + 0.001*q_chaux*(1000*fechaux + fetransp*transp_chaux) + 0.001*q_fecl3*(1000*fefecl3 + fetransp*transp_fecl3)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 construction filtre_a_presse 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction filtre_a_presse 3', 'CO2 construction filtre_a_presse 1', 'CO2 exploitation intrant filtre_a_presse 6', 'tbentrant compostage 1']::varchar[],
transp_fecl3 real,
transp_poly real default 50::real,
q_chaux real,
transp_chaux real,
...
commit ; 
insert into ___.input_output values ('tamis', array['eh', 'munite_tamis', 'qmax', 'welec', 'compt', 'qe', 'mes', 'dbo5']::varchar[], array['qe_s']::varchar[], array['CO2 construction tamis 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation tamis 1', 'CO2 construction tamis 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=fepoids*munite_tamis*qe/qmax', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=eh*fedechet*rhodechet*(compt*qdechet_tamis_comp - qdechet_tamis_ncomp*(compt - 1))', 'co2_c=eh*fepoids*munite_tamis*qe_eh/qmax', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 construction tamis 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation tamis 1', 'CO2 construction tamis 1', 'tbentrant compostage 1']::varchar[],
eh real,
...
commit ; 
insert into ___.input_output values ('conditionnement_chimique', array['transp_fecl3', 'q_catio', 'q_chaux', 'transp_chaux', 'transp_anio', 'q_fecl3', 'q_anio', 'transp_catio', 'vboue', 'fecc', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction conditionnement_chimique 1', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction conditionnement_chimique 3', 'CO2 construction conditionnement_chimique 2', 'CO2 exploitation conditionnement_chimique 3', 'CO2 exploitation intrant conditionnement_chimique 6', 'tbentrant compostage 1']::varchar[]) ;

create sequence ___.conditionnement_chimique_bloc_name_seq ;     

create type ___.fecc_type as enum ('Petite cuve', 'Cuve moyenne', 'Grand cuve');
...
formula varchar[] default array['co2_c=0.0005*eh*fecc*nbjour*(dbo5_eh + mes_eh)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_c=fecc*tbentrant', 'co2_c=0.0005*fecc*nbjour*(dbo5 + mes)', 'co2_e=feelec*vboue*welec_cc', 'co2_e=0.001*q_anio*(1000*feanionique + fetransp*transp_anio) + 0.001*q_catio*(1000*fecationique + fetransp*transp_catio) + 0.001*q_chaux*(1000*fechaux + fetransp*transp_chaux) + 0.001*q_fecl3*(1000*fefecl3 + fetransp*transp_fecl3)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 construction conditionnement_chimique 1', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction conditionnement_chimique 3', 'CO2 construction conditionnement_chimique 2', 'CO2 exploitation conditionnement_chimique 3', 'CO2 exploitation intrant conditionnement_chimique 6', 'tbentrant compostage 1']::varchar[],
transp_fecl3 real,
q_catio real,
q_chaux real,
transp_chaux real,
...
transp_catio real,
vboue real,
fecc ___.fecc_type not null default 'Petite cuve' references ___.fecc_type_table(val),
eh real,
dbo5 real,
mes real,
tbentrant real,
...
commit ; 
insert into ___.input_output values ('bassin_cylindrique', array['tauenterre', 'vu', 'h', 'e']::varchar[], array[]::varchar[], array['CO2 construction bassin_cylindrique 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('bassin_dorage', array['prod_e', 'eh', 'tsejour', 'tauenterre', 'h', 'e', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'qe', 'dco', 'ntk', 'mes', 'dbo5', 'vu', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 construction bassin_cylindrique 3', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction bassin_dorage 1', 'CO2 construction bassin_dorage 2', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('digesteur__methaniseur', array['tbsortant', 'tau_abattement', 'eh', 'mes', 'dbo5', 'vbiogaz', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 construction digesteur__methaniseur 3', 'CO2 elec 6', 'CO2 exploitation digesteur__methaniseur 3', 'CO2 construction digesteur__methaniseur 4', 'CH4 exploitation digesteur__methaniseur 3', 'tbsortant_s digesteur__methaniseur 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=225*feobj_dan*tbsortant', 'co2_e=feelec*welec', 'co2_e=feelec*tbsortant*welec_dan', 'co2_c=feobj_dan*vbiogaz', 'ch4_e=tbsortant*tau_fuite*vol_ms', 'tbsortant_s=tbsortant*tau_abattement', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 construction digesteur__methaniseur 3', 'CO2 elec 6', 'CO2 exploitation digesteur__methaniseur 3', 'CO2 construction digesteur__methaniseur 4', 'CH4 exploitation digesteur__methaniseur 3', 'tbsortant_s digesteur__methaniseur 3', 'tbentrant compostage 1']::varchar[],
tbsortant real,
...
commit ; 
insert into ___.input_output values ('conditionnement_thermiqu', array['eh', 'vboue', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction conditionnement_thermiqu 1', 'CO2 construction conditionnement_thermiqu 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation conditionnement_thermiqu 3', 'CO2 construction conditionnement_thermiqu 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj50_ct)*(eh>10000)*(eh<100000)+(feobj100_ct)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_c=((feobj50_ct)*(eh>10000)*(eh<100000)+(feobj100_ct)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=feelec*vboue*welec_ct', 'co2_c=((feobj50_ct)*(eh>10000)*(eh<100000)+(feobj100_ct)*(eh>100000))*tbentrant', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 construction conditionnement_thermiqu 1', 'CO2 construction conditionnement_thermiqu 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation conditionnement_thermiqu 3', 'CO2 construction conditionnement_thermiqu 3', 'tbentrant compostage 1']::varchar[],
eh real,
vboue real,
dbo5 real,
mes real,
...
commit ; 
insert into ___.input_output values ('sechage_solaire', array['siccite_e', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['siccite_s', 'tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction sechage_solaire 2', 'CO2 construction sechage_solaire 3', 'CO2 construction sechage_solaire 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_c=((feobj50_ss)*(eh>10000)*(eh<100000)+(feobj100_ss)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj50_ss)*(eh>10000)*(eh<100000)+(feobj100_ss)*(eh>100000))*tbentrant', 'co2_c=((feobj50_ss)*(eh>10000)*(eh<100000)+(feobj100_ss)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction sechage_solaire 2', 'CO2 construction sechage_solaire 3', 'CO2 construction sechage_solaire 1', 'tbentrant compostage 1']::varchar[],
siccite_e real,
eh real,
dbo5 real,
mes real,
...
commit ; 
insert into ___.input_output values ('station_de_pompage', array['tauenterre', 'vu', 'h', 'e']::varchar[], array[]::varchar[], array['CO2 construction bassin_cylindrique 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('rejets', array['eh', 'abatdco', 'fech4_mil', 'fen2o_oxi', 'abatngl', 'dco', 'ngl']::varchar[], array[]::varchar[], array['N2O exploitation rejets 2', 'CH4 exploitation rejets 1', 'N2O exploitation rejets 1', 'CH4 exploitation rejets 2']::varchar[]) ;
...
formula varchar[] default array['n2o_e=fen2o_oxi*ngl', 'ch4_e=eh*fech4_mil*dco_eh*(1 - abatdco)', 'n2o_e=eh*fen2o_oxi*ntk_eh*(1 - abatngl)', 'ch4_e=dco*fech4_mil']::varchar[],
formula_name varchar[] default array['N2O exploitation rejets 2', 'CH4 exploitation rejets 1', 'N2O exploitation rejets 1', 'CH4 exploitation rejets 2']::varchar[],
eh real,
...
commit ; 
insert into ___.input_output values ('clarificateur', array['prod_e', 'taur', 'eh', 'tauenterre', 'vit', 'h', 'e', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'qe', 'dco', 'ntk', 'mes', 'dbo5', 'vu', 'welec']::varchar[], array['tbentrant_s', 'ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 construction clarificateur 2', 'ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 construction bassin_cylindrique 3', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'ngl_s mbbr 3', 'CO2 construction clarificateur 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=(febet*e*rhobet*(3.14159*h*vit*(e + 5.52791*(qe*(taur + 1)/vit)**0.5) + 24*qe*(taur + 1)) + 24.0*vit*(0.3618*e + (qe*(taur + 1)/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/vit', 'ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=(febet*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*h*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/h', 'co2_e=feelec*welec', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'dco_s=eh*dco_eh*(1 - abatdco)', 'dco_s=dco*(1 - abatdco)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_c=(febet*e*rhobet*(24*eh*qe_eh*(taur + 1) + 3.14159*h*vit*(e + 5.52791*(eh*qe_eh*(taur + 1)/vit)**0.5)) + 24.0*vit*(0.3618*e + (eh*qe_eh*(taur + 1)/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/vit', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
...
commit ; 
insert into ___.input_output values ('stockage_boue', array['grand', 'aere', 'dbo', 'eh', 'welec', 'festock', 'mes', 'dbo5', 'tbentrant']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 exploitation stockage_boue 3', 'CO2 elec 6', 'CH4 exploitation stockage_boue 2', 'CO2 exploitation stockage_boue 2', 'CO2 construction stockage_boue 1', 'CO2 construction stockage_boue 2', 'CO2 exploitation stockage_boue 1', 'CO2 construction stockage_boue 3', 'tbentrant compostage 1']::varchar[]) ;

create sequence ___.stockage_boue_bloc_name_seq ;     

create type ___.festock_type as enum ('Silo de 250m3', 'Silo de 5m3', 'Silo de 500m3');
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=fesilo_aere*tbentrant*aere', 'co2_e=feelec*welec', 'ch4_e=-dbo*(aere - 1)*(fesilo_grand*grand - fesilo_petit*(grand - 1))', 'co2_e=0.0005*fesilo_aere*nbjour*aere*(dbo5 + mes)', 'co2_c=0.0005*eh*festock*nbjour*(dbo5_eh + mes_eh)', 'co2_c=0.0005*festock*nbjour*(dbo5 + mes)', 'co2_e=0.0005*eh*fesilo_aere*nbjour*aere*(dbo5_eh + mes_eh)', 'co2_c=festock*tbentrant', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 exploitation stockage_boue 3', 'CO2 elec 6', 'CH4 exploitation stockage_boue 2', 'CO2 exploitation stockage_boue 2', 'CO2 construction stockage_boue 1', 'CO2 construction stockage_boue 2', 'CO2 exploitation stockage_boue 1', 'CO2 construction stockage_boue 3', 'tbentrant compostage 1']::varchar[],
...
commit ; 
insert into ___.input_output values ('chaulage', array['eh', 'dbo5', 'mes', 'tbentrant', 'welec', 'q_chaux', 'transp_chaux']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 construction chaulage 3', 'CO2 elec 6', 'CO2 construction chaulage 2', 'CO2 exploitation q_chaux chaulage 6', 'CO2 construction chaulage 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=((feobj10_ch)*(eh<10000)+(feobj50_ch)*(eh>10000)*(eh<100000)+(feobj100_ch)*(eh>100000))*tbentrant', 'co2_e=feelec*welec', 'co2_c=((feobj10_ch)*(eh<10000)+(feobj50_ch)*(eh>10000)*(eh<100000)+(feobj100_ch)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=0.001*q_chaux*(1000*fechaux + fetransp*transp_chaux)', 'co2_c=((feobj10_ch)*(eh<10000)+(feobj50_ch)*(eh>10000)*(eh<100000)+(feobj100_ch)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 construction chaulage 3', 'CO2 elec 6', 'CO2 construction chaulage 2', 'CO2 exploitation q_chaux chaulage 6', 'CO2 construction chaulage 1', 'tbentrant compostage 1']::varchar[],
eh real,
dbo5 real,
mes real,
tbentrant real,
...
commit ; 
insert into ___.input_output values ('epaississement_statique', array['eh', 'tbsortant', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction epaississement_statique 1', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction epaississement_statique 3', 'CO2 construction epaississement_statique 2', 'CO2 exploitation epaississement_statique 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj10_es)*(eh<10000)+(feobj50_es)*(eh>10000)*(eh<100000)+(feobj100_es)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_c=((feobj10_es)*(eh<10000)+(feobj50_es)*(eh>10000)*(eh<100000)+(feobj100_es)*(eh>100000))*tbentrant', 'co2_c=((feobj10_es)*(eh<10000)+(feobj50_es)*(eh>10000)*(eh<100000)+(feobj100_es)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=feelec*tbsortant*welec_es', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 construction epaississement_statique 1', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction epaississement_statique 3', 'CO2 construction epaississement_statique 2', 'CO2 exploitation epaississement_statique 3', 'tbentrant compostage 1']::varchar[],
eh real,
tbsortant real,
dbo5 real,
mes real,
...
commit ; 
insert into ___.input_output values ('bassin_biologique', array['prod_e', 'eh', 'charge_bio', 'tauenterre', 'h', 'e', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'dbo5', 'dco', 'ntk', 'mes', 'vu', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['ngl_s mbbr 3', 'CO2 construction bassin_biologique 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 construction bassin_cylindrique 3', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction bassin_biologique 2', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['ngl_s=ntk*(1 - abatngl)', 'co2_c=(febet*e*rhobet*(24*eh*dbo5_eh + 3.14159*h**2*charge_bio*(e + 5.52791*(eh*dbo5_eh/(h*charge_bio))**0.5)) + 24.0*h*charge_bio*(0.3618*e + (eh*dbo5_eh/(h*charge_bio))**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/(h*charge_bio)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=(febet*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*h*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/h', 'co2_e=feelec*welec', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'dco_s=eh*dco_eh*(1 - abatdco)', 'dco_s=dco*(1 - abatdco)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_c=(febet*e*rhobet*(24*dbo5 + 3.14159*h**2*charge_bio*(e + 5.52791*(dbo5/(h*charge_bio))**0.5)) + 24.0*h*charge_bio*(0.3618*e + (dbo5/(h*charge_bio))**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/(h*charge_bio)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['ngl_s mbbr 3', 'CO2 construction bassin_biologique 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 construction bassin_cylindrique 3', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction bassin_biologique 2', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[],
prod_e ___.prod_e_type not null default 'Acide sulfurique' references ___.prod_e_type_table(val),
eh real,
...
commit ; 
insert into ___.input_output values ('grilles_degouttage', array['q_poly', 'transp_poly', 'tbsortant', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction grilles_degouttage 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation grilles_degouttage 3', 'CO2 construction grilles_degouttage 3', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction grilles_degouttage 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj10_ge)*(eh<10000)+(feobj50_ge)*(eh>10000)*(eh<100000)+(feobj100_ge)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=feelec*tbsortant*welec_ge', 'co2_c=((feobj10_ge)*(eh<10000)+(feobj50_ge)*(eh>10000)*(eh<100000)+(feobj100_ge)*(eh>100000))*tbentrant', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_ge)*(eh<10000)+(feobj50_ge)*(eh>10000)*(eh<100000)+(feobj100_ge)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 construction grilles_degouttage 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation grilles_degouttage 3', 'CO2 construction grilles_degouttage 3', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction grilles_degouttage 1', 'tbentrant compostage 1']::varchar[],
...
commit ; 
insert into ___.input_output values ('sechage_thermique', array['siccite_e', 'eh', 'tbsortant', 'pelletisation', 'dbo5', 'mes', 'tbentrant', 'tee', 'welec']::varchar[], array['siccite_s', 'tbsortant_s']::varchar[], array['CO2 construction sechage_thermique 3', 'CO2 exploitation sechage_thermique 4', 'CO2 construction sechage_thermique 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation sechage_thermique 3', 'CO2 construction sechage_thermique 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj50_st)*(eh>10000)*(eh<100000)+(feobj100_st)*(eh>100000))*tbentrant', 'co2_e=feelec*(24*nbjour*pth*tee - tbsortant*(welec_st_nopell*(pelletisation - 1) - welec_st_pell*pelletisation))', 'co2_c=((feobj50_st)*(eh>10000)*(eh<100000)+(feobj100_st)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=feelec*tbsortant*(24*nbjour*pth*(siccite_e - siccite_s) - welec_st_nopell*(pelletisation - 1) + welec_st_pell*pelletisation)', 'co2_c=((feobj50_st)*(eh>10000)*(eh<100000)+(feobj100_st)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 construction sechage_thermique 3', 'CO2 exploitation sechage_thermique 4', 'CO2 construction sechage_thermique 2', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation sechage_thermique 3', 'CO2 construction sechage_thermique 1', 'tbentrant compostage 1']::varchar[],
siccite_e real,
eh real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('lagunage', array['prod_e', 'eh', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'dco', 'ntk', 'mes', 'dbo5', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'dco_s=eh*dco_eh*(1 - abatdco)', 'dco_s=dco*(1 - abatdco)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[],
prod_e ___.prod_e_type not null default 'Acide sulfurique' references ___.prod_e_type_table(val),
eh real,
abatdco real,
abatngl real,
...
commit ; 
insert into ___.input_output values ('compostage', array['eh', 'tbsortant', 'mes', 'dbo5', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 exploitation compostage 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction compostage 1', 'CO2 construction compostage 3', 'N2O exploitation compostage 3', 'CO2 construction compostage 2', 'CH4 exploitation compostage 3', 'CO2 exploitation compostage 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_e=fegazole*tbsortant*gazole_compost', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_c=0.0005*eh*fecompost*nbjour*(dbo5_eh + mes_eh)', 'co2_c=fecompost*tbentrant', 'n2o_e=tbsortant*n2o_compost', 'co2_c=0.0005*fecompost*nbjour*(dbo5 + mes)', 'ch4_e=tbsortant*ch4_compost', 'co2_e=feelec*tbsortant*welec_compost', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
...
commit ; 
insert into ___.input_output values ('degazage', array['prod_e', 'eh', 'tauenterre', 'vit', 'h', 'e', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'qe', 'dco', 'ntk', 'mes', 'dbo5', 'vu', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 construction bassin_cylindrique 3', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'CO2 construction degazage 2', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction dessableurdegraisseur 1', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=(febet*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*h*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/h', 'co2_e=feelec*welec', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'co2_c=(febet*e*rhobet*(3.14159*h*vit*(e + 5.52791*(qe/vit)**0.5) + 24*qe) + 24.0*vit*(0.3618*e + (qe/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/vit', 'dco_s=eh*dco_eh*(1 - abatdco)', 'dco_s=dco*(1 - abatdco)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_c=(febet*e*rhobet*(24*eh*qe_eh + 3.14159*h*vit*(e + 5.52791*(eh*qe_eh/vit)**0.5)) + 24.0*vit*(0.3618*e + (eh*qe_eh/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/vit', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 construction bassin_cylindrique 3', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'CO2 construction degazage 2', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction dessableurdegraisseur 1', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[],
prod_e ___.prod_e_type not null default 'Acide sulfurique' references ___.prod_e_type_table(val),
eh real,
tauenterre real default 0.75::real,
...
commit ; 
insert into ___.input_output values ('centrifugeuse_pour_deshy', array['q_poly', 'transp_poly', 'tbsortant', 'direct', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 exploitation centrifugeuse_pour_deshy 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction centrifugeuse_pour_deshy 2', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction centrifugeuse_pour_deshy 3', 'CO2 construction centrifugeuse_pour_deshy 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*tbsortant*(-welec_cd*direct + welec_cd + welec_direct*direct)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_c=((feobj10_cd)*(eh<10000)+(feobj50_cd)*(eh>10000)*(eh<100000)+(feobj100_cd)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_cd)*(eh<10000)+(feobj50_cd)*(eh>10000)*(eh<100000)+(feobj100_cd)*(eh>100000))*tbentrant', 'co2_c=((feobj10_cd)*(eh<10000)+(feobj50_cd)*(eh>10000)*(eh<100000)+(feobj100_cd)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 exploitation centrifugeuse_pour_deshy 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction centrifugeuse_pour_deshy 2', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction centrifugeuse_pour_deshy 3', 'CO2 construction centrifugeuse_pour_deshy 1', 'tbentrant compostage 1']::varchar[],
...
commit ; 
insert into ___.input_output values ('flottateur', array['q_poly', 'transp_poly', 'tbsortant', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 construction flottateur 3', 'CO2 exploitation flottateur 3', 'CO2 elec 6', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction flottateur 2', 'CO2 construction flottateur 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=((feobj10_flot)*(eh<10000)+(feobj50_flot)*(eh>10000)*(eh<100000)+(feobj100_flot)*(eh>100000))*tbentrant', 'co2_e=feelec*tbsortant*welec_flot', 'co2_e=feelec*welec', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_flot)*(eh<10000)+(feobj50_flot)*(eh>10000)*(eh<100000)+(feobj100_flot)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj10_flot)*(eh<10000)+(feobj50_flot)*(eh>10000)*(eh<100000)+(feobj100_flot)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 construction flottateur 3', 'CO2 exploitation flottateur 3', 'CO2 elec 6', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction flottateur 2', 'CO2 construction flottateur 1', 'tbentrant compostage 1']::varchar[],
...
commit ; 
insert into ___.input_output values ('filtre_a_bande', array['q_poly', 'transp_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction filtre_a_bande 2', 'CO2 construction filtre_a_bande 1', 'CO2 construction filtre_a_bande 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_fb)*(eh<10000)+(feobj50_fb)*(eh>10000)*(eh<100000)+(feobj100_fb)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj10_fb)*(eh<10000)+(feobj50_fb)*(eh>10000)*(eh<100000)+(feobj100_fb)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_c=((feobj10_fb)*(eh<10000)+(feobj50_fb)*(eh>10000)*(eh<100000)+(feobj100_fb)*(eh>100000))*tbentrant', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction filtre_a_bande 2', 'CO2 construction filtre_a_bande 1', 'CO2 construction filtre_a_bande 3', 'tbentrant compostage 1']::varchar[],
q_poly real default 5::real,
transp_poly real default 50::real,
eh real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('degrilleur', array['eh', 'qdechet', 'welec', 'qmax', 'munite_degrilleur', 'qe', 'mes', 'dbo5']::varchar[], array['qe_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation degrilleur 1', 'CO2 construction degrilleur 2', 'CO2 construction degrilleur 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=eh*fedechet*qdechet*rhodechet', 'co2_c=fepoids*munite_degrilleur*qe/qmax', 'co2_c=eh*fepoids*munite_degrilleur*qe_eh/qmax', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation degrilleur 1', 'CO2 construction degrilleur 2', 'CO2 construction degrilleur 1', 'tbentrant compostage 1']::varchar[],
eh real,
...
commit ; 
insert into ___.input_output values ('usine', array[]::varchar[], array[]::varchar[], array[]::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('decanteur_lamellaire', array['prod_e', 'eh', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'dco', 'ntk', 'mes', 'dbo5', 'tauenterre', 'long', 'h', 'e', 'larg', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction decanteur_lamellaire 3', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'dco_s=eh*dco_eh*(1 - abatdco)', 'dco_s=dco*(1 - abatdco)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_c=febet*e*rhobet*(larg*long + 2*larg*(h + e) + 2*long*(h + e)) + feevac*rhoterre*tauenterre*(h + e)*(e + larg)*(e + long) + fefonda*(e + larg)*(e + long) + fepelle*cad*tauenterre*(h + e)*(e + larg)*(e + long)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction decanteur_lamellaire 3', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[],
prod_e ___.prod_e_type not null default 'Acide sulfurique' references ___.prod_e_type_table(val),
eh real,
abatdco real,
abatngl real,
...
commit ; 
insert into ___.input_output values ('filiere_eau', array['prod_e', 'eh', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'dco', 'ntk', 'mes', 'dbo5', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('tables_degouttage', array['q_poly', 'transp_poly', 'tbsortant', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction tables_degouttage 2', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 exploitation tables_degouttage 3', 'CO2 construction tables_degouttage 1', 'CO2 construction tables_degouttage 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_c=((feobj10_te)*(eh<10000)+(feobj50_te)*(eh>10000)*(eh<100000)+(feobj100_te)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_e=feelec*tbsortant*welec_te', 'co2_c=((feobj10_te)*(eh<10000)+(feobj50_te)*(eh>10000)*(eh<100000)+(feobj100_te)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_c=((feobj10_te)*(eh<10000)+(feobj50_te)*(eh>10000)*(eh<100000)+(feobj100_te)*(eh>100000))*tbentrant', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction tables_degouttage 2', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 exploitation tables_degouttage 3', 'CO2 construction tables_degouttage 1', 'CO2 construction tables_degouttage 3', 'tbentrant compostage 1']::varchar[],
q_poly real default 5::real,
transp_poly real default 50::real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('digesteur_aerobie', array['eh', 'tbsortant', 'tau_abattement', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 exploitation digesteur_aerobie 3', 'CO2 elec 6', 'CO2 construction digesteur_aerobie 1', 'CO2 construction digesteur_aerobie 2', 'CO2 construction digesteur_aerobie 3', 'tbsortant_s digesteur__methaniseur 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*tbsortant*welec_da', 'co2_e=feelec*welec', 'co2_c=((feobj10_da)*(eh<10000)+(feobj50_da)*(eh>10000)*(eh<100000)+(feobj100_da)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'co2_c=((feobj10_da)*(eh<10000)+(feobj50_da)*(eh>10000)*(eh<100000)+(feobj100_da)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj10_da)*(eh<10000)+(feobj50_da)*(eh>10000)*(eh<100000)+(feobj100_da)*(eh>100000))*tbentrant', 'tbsortant_s=tbsortant*tau_abattement', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 exploitation digesteur_aerobie 3', 'CO2 elec 6', 'CO2 construction digesteur_aerobie 1', 'CO2 construction digesteur_aerobie 2', 'CO2 construction digesteur_aerobie 3', 'tbsortant_s digesteur__methaniseur 3', 'tbentrant compostage 1']::varchar[],
eh real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('filiere_boue', array['eh', 'welec', 'mes', 'dbo5']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'tbentrant compostage 1']::varchar[]) ;
...
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'tbentrant compostage 1']::varchar[],
eh real,
welec real,
mes real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('centrifugeuse_pour_epais', array['q_poly', 'transp_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction centrifugeuse_pour_epais 2', 'CO2 construction centrifugeuse_pour_epais 3', 'CO2 construction centrifugeuse_pour_epais 1', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_ce)*(eh<10000)+(feobj50_ce)*(eh>10000)*(eh<100000)+(feobj100_ce)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)', 'co2_c=((feobj10_ce)*(eh<10000)+(feobj50_ce)*(eh>10000)*(eh<100000)+(feobj100_ce)*(eh>100000))*tbentrant', 'co2_c=((feobj10_ce)*(eh<10000)+(feobj50_ce)*(eh>10000)*(eh<100000)+(feobj100_ce)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation q_poly centrifugeuse_pour_epais 6', 'CO2 construction centrifugeuse_pour_epais 2', 'CO2 construction centrifugeuse_pour_epais 3', 'CO2 construction centrifugeuse_pour_epais 1', 'tbentrant compostage 1']::varchar[],
q_poly real default 0::real,
transp_poly real default 50::real,
eh real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('fpr', array['prod_e', 'eh', 's_geom_eh', 'h', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'dco', 'ntk', 'mes', 'dbo5', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction fpr 1', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'dco_s=eh*dco_eh*(1 - abatdco)', 'dco_s=dco*(1 - abatdco)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_c=eh*s_geom_eh*(feevac*h*rhoterre + fegeom + fepelle*h*cad)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction fpr 1', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[],
prod_e ___.prod_e_type not null default 'Acide sulfurique' references ___.prod_e_type_table(val),
eh real,
...
commit ; 
insert into ___.input_output values ('mbbr', array['prod_e', 'tauenterre', 'smateriau', 'h', 's_v', 'e', 'tau_remp', 'eh', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'dco', 'ntk', 'mes', 'dbo5', 'vu', 'welec']::varchar[], array['dbo5_s', 'ngl_s', 'dco_s', 'qe_s']::varchar[], array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 construction bassin_cylindrique 3', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction mbbr 3', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['ngl_s=ntk*(1 - abatngl)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=(febet*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*h*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/h', 'co2_e=feelec*welec', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'dco_s=eh*dco_eh*(1 - abatdco)', 'dco_s=dco*(1 - abatdco)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_c=(febet*e*rhobet*(3.14159*h**2*s_v*tau_remp*(e + 5.52791*(smateriau/(h*s_v*tau_remp))**0.5) + 24*smateriau) + 24.0*h*s_v*tau_remp*(0.3618*e + (smateriau/(h*s_v*tau_remp))**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/(h*s_v*tau_remp)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['ngl_s mbbr 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 construction bassin_cylindrique 3', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'CO2 construction mbbr 3', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[],
prod_e ___.prod_e_type not null default 'Acide sulfurique' references ___.prod_e_type_table(val),
tauenterre real default 0.75::real,
smateriau real,
...
commit ; 
insert into ___.input_output values ('deconstruction', array[]::varchar[], array[]::varchar[], array[]::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('brm', array['prod_e', 'tauenterre', 'vu', 'h', 'e', 'eh', 'abatdco', 'abatngl', 'dbo5elim', 'w_dbo5_eau', 'q_soude', 'q_sulf', 'transp_sable_t', 'q_naclo3', 'transp_anio', 'transp_phosphorique', 'transp_antiscalant', 'transp_cl2', 'q_kmno4', 'transp_ethanol', 'transp_mhetanol', 'transp_caco3', 'transp_sulf_alu', 'q_phosphorique', 'transp_ca_poudre', 'transp_catio', 'q_h2o2', 'q_catio', 'q_chaux', 'q_sulf_alu', 'transp_nitrique', 'transp_citrique', 'transp_chaux', 'transp_ca_neuf', 'transp_h2o2', 'transp_kmno4', 'q_cl2', 'transp_soude', 'q_sable_t', 'q_hcl', 'q_rei', 'q_ca_regen', 'q_soude_c', 'transp_poly', 'q_anti_mousse', 'q_sulf_sod', 'q_ca_neuf', 'q_anio', 'q_citrique', 'q_nahso3', 'q_ethanol', 'q_caco3', 'transp_hcl', 'q_oxyl', 'q_poly', 'q_uree', 'transp_uree', 'transp_naclo3', 'q_antiscalant', 'transp_rei', 'transp_soude_c', 'transp_anti_mousse', 'q_ca_poudre', 'transp_ca_regen', 'transp_oxyl', 'q_mhetanol', 'transp_sulf_sod', 'q_nitrique', 'transp_sulf', 'transp_nahso3', 'dco', 'ntk', 'mes', 'dbo5', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['ngl_s mbbr 3', 'CO2 construction bassin_cylindrique 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[]) ;
...
formula varchar[] default array['ngl_s=ntk*(1 - abatngl)', 'co2_c=(febet*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*h*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda + fepelle*cad*tauenterre*(h + e)))/h', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'dco_s=eh*dco_eh*(1 - abatdco)', 'dco_s=dco*(1 - abatdco)', 'co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['ngl_s mbbr 3', 'CO2 construction bassin_cylindrique 3', 'tbentrant centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 exploitation lagunage 3', 'dco_s filiere_eau 3', 'dco_s filiere_eau 3', 'CO2 exploitation intrant bassin_biologique 6', 'ngl_s mbbr 3', 'tbentrant compostage 1']::varchar[],
prod_e ___.prod_e_type not null default 'Acide sulfurique' references ___.prod_e_type_table(val),
tauenterre real default 0.75::real,
vu real,
h real default 4::real,
