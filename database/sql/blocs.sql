...
create type ___.prod_e_type as enum ('Sulfate de sodium', 'Peroxyde d’hydrogène', 'Urée', 'Oxygène liquide', 'Carbonate de calcium', 'Antiscalants', 'Chaux', 'Sulfate d’aluminium', 'Permanganate de potassium', 'Chlore', 'Poudre de calcium', 'Méthanol', 'Acide citrique', 'Acide phosphorique', 'Acide sulfurique', 'Soude', 'Éthanol', 'Résine anionique', 'Acide chlorhydrique', 'Antimousse', 'Bisulfite de sodium', 'Floculant', 'Acide nitrique', 'Résine échangeuse d’ions', 'Chlorate de sodium', 'Résine cationique', 'Cristaux de soude', 'Régénérant de calcium', 'Calcium neuf', 'Sable de filtration');
...
commit ; 
insert into ___.input_output values ('station_de_pompage', array['e', 'tauenterre', 'h', 'vu']::varchar[], array[]::varchar[], array['CO2 construction bassin_cylindrique 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('bassin_cylindrique', array['e', 'tauenterre', 'h', 'vu']::varchar[], array[]::varchar[], array['CO2 construction bassin_cylindrique 3']::varchar[]) ;
...
create type ___.fecc_type as enum ('Petite cuve', 'Grand cuve', 'Cuve moyenne');
...
commit ; 
insert into ___.input_output values ('rejets', array['eh', 'abatdco', 'fech4_mil', 'abatngl', 'fen2o_oxi', 'dco', 'ngl']::varchar[], array[]::varchar[], array['CH4 exploitation rejets 2', 'N2O exploitation rejets 2', 'N2O exploitation rejets 1', 'CH4 exploitation rejets 1']::varchar[]) ;
...
formula varchar[] default array['ch4_e=dco*fech4_mil', 'n2o_e=fen2o_oxi*ngl', 'n2o_e=eh*fen2o_oxi*ntk_eh*(1 - abatngl)', 'ch4_e=eh*fech4_mil*dco_eh*(1 - abatdco)']::varchar[],
formula_name varchar[] default array['CH4 exploitation rejets 2', 'N2O exploitation rejets 2', 'N2O exploitation rejets 1', 'CH4 exploitation rejets 1']::varchar[],
eh real,
