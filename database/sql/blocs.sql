...
commit ; 
insert into ___.input_output values ('mbbr', array['prod_e', 'd_vie', 'e', 's_v', 'h', 'tau_remp', 'tauenterre', 'smateriau', 'eh', 'abatdco', 'abatngl', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'dco', 'ntk', 'dbo5', 'mes', 'vu', 'welec']::varchar[], array['dbo5_s', 'ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 construction mbbr 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;

create sequence ___.mbbr_bloc_name_seq ;     

create type ___.prod_e_type as enum ('Sulfate de sodium', 'Chlorure ferrique', 'Antiscalants', 'Résine cationique', 'Éthanol', 'Méthanol', 'Eau de javel', 'Calcium neuf', 'Poudre de calcium', 'Lait de chaux', 'Coagulants liquide', 'Chaux', 'Oxygène liquide', 'Chlorate de sodium', 'Permanganate de potassium', 'Sulfate d’aluminium', 'Acide nitrique', 'Chlore', 'Antimousse', 'Sable de filtration', 'Régénérant de calcium', 'Urée', 'Acide phosphorique', 'Acide citrique', 'Floculant', 'Acide sulfurique', 'Peroxyde d’hydrogène', 'Cristaux de soude', 'Bisulfite de sodium', 'Résine anionique', 'Soude', 'Acide chlorhydrique', 'Résine échangeuse d’ions', 'CO2 liquide', 'Carbonate de calcium');
...
select api.add_new_formula('dco_s clarificateur 3'::varchar, 'dco_s=eh*dco_eh*(1 - abatdco)'::varchar, 3, ''::text) ;
select api.add_new_formula('CO2 construction mbbr 3'::varchar, 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*s_v*tau_remp*(e + 5.52791*(smateriau/(h*s_v*tau_remp))**0.5) + 24*smateriau) + 24.0*fepelle*h*s_v*tau_remp*tauenterre*(h + e)*(0.3618*e + (smateriau/(h*s_v*tau_remp))**0.5)**2 + 24.0*h*cad*s_v*tau_remp*(0.3618*e + (smateriau/(h*s_v*tau_remp))**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad*s_v*tau_remp)'::varchar, 3, ''::text) ;
select api.add_new_formula('tbentrant digesteur_aerobie 2'::varchar, 'tbentrant=0.0005*nbjour*(dbo5 + mes)'::varchar, 2, ''::text) ;
select api.add_new_formula('dco_s clarificateur 3'::varchar, 'dco_s=dco*(1 - abatdco)'::varchar, 3, ''::text) ;
select api.add_new_formula('tbentrant filtre_a_presse 1'::varchar, 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)'::varchar, 1, ''::text) ;
...
commit ; 
insert into ___.input_output values ('bassin_biologique', array['prod_e', 'd_vie', 'e', 'eh', 'h', 'charge_bio', 'tauenterre', 'abatdco', 'abatngl', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'dbo5', 'dco', 'ntk', 'mes', 'vu', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 construction bassin_biologique 1', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 construction bassin_biologique 2', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_co2l*(fetransp*transp_co2l + 1000*fe_co2l) + 0.001*q_coagl*(fetransp*transp_coagl + 1000*fe_coagl) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_fecl3*(fetransp*transp_fecl3 + 1000*fe_fecl3) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_javel*(fetransp*transp_javel + 1000*fe_javel) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_lait*(fetransp*transp_lait + 1000*fe_lait) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'dco_s=eh*dco_eh*(1 - abatdco)', 'co2_c=(febet*cad*e*rhobet*(24*eh*dbo5_eh + 3.14159*h**2*charge_bio*(e + 5.52791*(eh*dbo5_eh/(h*charge_bio))**0.5)) + 24.0*fepelle*h*charge_bio*tauenterre*(h + e)*(0.3618*e + (eh*dbo5_eh/(h*charge_bio))**0.5)**2 + 24.0*h*cad*charge_bio*(0.3618*e + (eh*dbo5_eh/(h*charge_bio))**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad*charge_bio)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=dco*(1 - abatdco)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (vu/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_c=(febet*cad*e*rhobet*(24*dbo5 + 3.14159*h**2*charge_bio*(e + 5.52791*(dbo5/(h*charge_bio))**0.5)) + 24.0*fepelle*h*charge_bio*tauenterre*(h + e)*(0.3618*e + (dbo5/(h*charge_bio))**0.5)**2 + 24.0*h*cad*charge_bio*(0.3618*e + (dbo5/(h*charge_bio))**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad*charge_bio)', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'ngl_s=ntk*(1 - abatngl)']::varchar[],
formula_name varchar[] default array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 construction bassin_biologique 1', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 construction bassin_biologique 2', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[],
prod_e ___.prod_e_type not null default 'Sulfate de sodium' references ___.prod_e_type_table(val),
d_vie real default 50::real,
e real default 0.25::real,
eh real,
...
commit ; 
insert into ___.input_output values ('decanteur_lamellaire', array['prod_e', 'd_vie', 'eh', 'abatdco', 'abatngl', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'dco', 'ntk', 'dbo5', 'mes', 'long', 'e', 'h', 'larg', 'tauenterre', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation intrant degazage 6', 'CO2 construction decanteur_lamellaire 3', 'CO2 elec 6', 'dco_s clarificateur 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_co2l*(fetransp*transp_co2l + 1000*fe_co2l) + 0.001*q_coagl*(fetransp*transp_coagl + 1000*fe_coagl) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_fecl3*(fetransp*transp_fecl3 + 1000*fe_fecl3) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_javel*(fetransp*transp_javel + 1000*fe_javel) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_lait*(fetransp*transp_lait + 1000*fe_lait) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_c=(fepelle*tauenterre*(h + e)*(e + larg)*(e + long) + cad*(febet*e*rhobet*(larg*long + 2*larg*(h + e) + 2*long*(h + e)) + feevac*rhoterre*tauenterre*(h + e)*(e + larg)*(e + long) + fefonda*(e + larg)*(e + long)))/cad', 'co2_e=feelec*welec', 'dco_s=eh*dco_eh*(1 - abatdco)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=dco*(1 - abatdco)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'ngl_s=ntk*(1 - abatngl)']::varchar[],
formula_name varchar[] default array['CO2 exploitation intrant degazage 6', 'CO2 construction decanteur_lamellaire 3', 'CO2 elec 6', 'dco_s clarificateur 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[],
prod_e ___.prod_e_type not null default 'Sulfate de sodium' references ___.prod_e_type_table(val),
d_vie real default 50::real,
eh real,
abatdco real,
...
commit ; 
insert into ___.input_output values ('batiment_dexploitation', array['s', 'feexpl', 'welec']::varchar[], array[]::varchar[], array['CO2 construction batiment_dexploitation 6', 'CO2 elec 6']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('dessableurdegraisseur', array['prod_e', 'd_vie', 'eh', 'lavage', 'conc', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'e', 'h', 'vit', 'tauenterre', 'abatdco', 'abatngl', 'qe', 'dco', 'ntk', 'dbo5', 'mes', 'tsables', 'tgraisses', 'vu', 'welec']::varchar[], array['qe_s', 'ngl_s', 'dco_s']::varchar[], array['CO2 exploitation intrant degazage 6', 'CO2 construction degazage 2', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 construction degazage 1', 'CO2 exploitation dessableurdegraisseur 1', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 exploitation dessableurdegraisseur 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_co2l*(fetransp*transp_co2l + 1000*fe_co2l) + 0.001*q_coagl*(fetransp*transp_coagl + 1000*fe_coagl) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_fecl3*(fetransp*transp_fecl3 + 1000*fe_fecl3) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_javel*(fetransp*transp_javel + 1000*fe_javel) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_lait*(fetransp*transp_lait + 1000*fe_lait) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_c=(febet*cad*e*rhobet*(3.14159*h*vit*(e + 5.52791*(qe/vit)**0.5) + 24*qe) + 24.0*fepelle*tauenterre*vit*(h + e)*(0.3618*e + (qe/vit)**0.5)**2 + 24.0*cad*vit*(0.3618*e + (qe/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(cad*vit)', 'co2_e=feelec*welec', 'dco_s=eh*dco_eh*(1 - abatdco)', 'co2_c=(febet*cad*e*rhobet*(24*eh*qe_eh + 3.14159*h*vit*(e + 5.52791*(eh*qe_eh/vit)**0.5)) + 24.0*fepelle*tauenterre*vit*(h + e)*(0.3618*e + (eh*qe_eh/vit)**0.5)**2 + 24.0*cad*vit*(0.3618*e + (eh*qe_eh/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(cad*vit)', 'co2_e=eh*(fedechet*dgraisses*(lgraisses_c*conc - lgraisses_nc*(conc - 1)) + fesables*(lavage*sables_lavé - sables_nlavé*(lavage - 1)))', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=dco*(1 - abatdco)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (vu/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=fedechet*tgraisses + fesables*tsables', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'ngl_s=ntk*(1 - abatngl)']::varchar[],
formula_name varchar[] default array['CO2 exploitation intrant degazage 6', 'CO2 construction degazage 2', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 construction degazage 1', 'CO2 exploitation dessableurdegraisseur 1', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 exploitation dessableurdegraisseur 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[],
prod_e ___.prod_e_type not null default 'Sulfate de sodium' references ___.prod_e_type_table(val),
d_vie real default 50::real,
eh real,
...
select api.add_new_formula('CO2 elec 6'::varchar, 'co2_e=feelec*welec'::varchar, 6, ''::text) ;
select api.add_new_formula('dco_s clarificateur 3'::varchar, 'dco_s=eh*dco_eh*(1 - abatdco)'::varchar, 3, ''::text) ;
select api.add_new_formula('CO2 construction degazage 1'::varchar, 'co2_c=(febet*cad*e*rhobet*(24*eh*qe_eh + 3.14159*h*vit*(e + 5.52791*(eh*qe_eh/vit)**0.5)) + 24.0*fepelle*tauenterre*vit*(h + e)*(0.3618*e + (eh*qe_eh/vit)**0.5)**2 + 24.0*cad*vit*(0.3618*e + (eh*qe_eh/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(cad*vit)'::varchar, 1, ''::text) ;
...
commit ; 
insert into ___.input_output values ('fpr', array['prod_e', 'd_vie', 's_geom_eh', 'eh', 'h', 'abatdco', 'abatngl', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'dco', 'ntk', 'dbo5', 'mes', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'tbentrant digesteur_aerobie 2', 'CO2 construction fpr 1', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_co2l*(fetransp*transp_co2l + 1000*fe_co2l) + 0.001*q_coagl*(fetransp*transp_coagl + 1000*fe_coagl) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_fecl3*(fetransp*transp_fecl3 + 1000*fe_fecl3) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_javel*(fetransp*transp_javel + 1000*fe_javel) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_lait*(fetransp*transp_lait + 1000*fe_lait) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'dco_s=eh*dco_eh*(1 - abatdco)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=eh*s_geom_eh*(feevac*h*rhoterre + fegeom + fepelle*h*cad)', 'dco_s=dco*(1 - abatdco)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'ngl_s=ntk*(1 - abatngl)']::varchar[],
formula_name varchar[] default array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'tbentrant digesteur_aerobie 2', 'CO2 construction fpr 1', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[],
prod_e ___.prod_e_type not null default 'Sulfate de sodium' references ___.prod_e_type_table(val),
d_vie real default 50::real,
...
commit ; 
insert into ___.input_output values ('degrilleur', array['d_vie', 'qdechet', 'eh', 'welec', 'qmax', 'munite_degrilleur', 'qe', 'dbo5', 'mes']::varchar[], array['qe_s']::varchar[], array['CO2 elec 6', 'tbentrant filtre_a_presse 1', 'CO2 exploitation degrilleur 1', 'CO2 construction degrilleur 2', 'tbentrant digesteur_aerobie 2', 'CO2 construction degrilleur 1']::varchar[]) ;

create sequence ___.degrilleur_bloc_name_seq ;     

create type ___.qdechet_type as enum ('Compactage avec vis', 'Compactage avec piston', 'Sans compactage');
...
formula varchar[] default array['co2_e=feelec*welec', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=eh*fedechet*qdechet*rhodechet', 'co2_c=fepoids*munite_degrilleur*qe/qmax', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=eh*fepoids*munite_degrilleur*qe_eh/qmax']::varchar[],
formula_name varchar[] default array['CO2 elec 6', 'tbentrant filtre_a_presse 1', 'CO2 exploitation degrilleur 1', 'CO2 construction degrilleur 2', 'tbentrant digesteur_aerobie 2', 'CO2 construction degrilleur 1']::varchar[],
...
commit ; 
insert into ___.input_output values ('tables_degouttage', array['d_vie', 'tbsortant', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 exploitation q_poly flottateur 6', 'CO2 elec 6', 'CO2 construction tables_degouttage 1', 'CO2 construction tables_degouttage 2', 'CO2 construction tables_degouttage 3', 'CO2 exploitation tables_degouttage 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_e=feelec*welec', 'co2_c=((feobj10_te)*(eh<10000)+(feobj50_te)*(eh>10000)*(eh<100000)+(feobj100_te)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_c=((feobj10_te)*(eh<10000)+(feobj50_te)*(eh>10000)*(eh<100000)+(feobj100_te)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'co2_c=((feobj10_te)*(eh<10000)+(feobj50_te)*(eh>10000)*(eh<100000)+(feobj100_te)*(eh>100000))*tbentrant*d_vie', 'co2_e=feelec*tbsortant*welec_te', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 exploitation q_poly flottateur 6', 'CO2 elec 6', 'CO2 construction tables_degouttage 1', 'CO2 construction tables_degouttage 2', 'CO2 construction tables_degouttage 3', 'CO2 exploitation tables_degouttage 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[],
d_vie real default 15::real,
tbsortant real,
transp_poly real default 50::real,
q_poly real,
...
select api.add_new_formula('CO2 exploitation q_poly flottateur 6'::varchar, 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)'::varchar, 6, ''::text) ;
select api.add_new_formula('CO2 elec 6'::varchar, 'co2_e=feelec*welec'::varchar, 6, ''::text) ;
...
commit ; 
insert into ___.input_output values ('sechage_solaire', array['siccite_e', 'd_vie', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['siccite_s', 'tbsortant_s']::varchar[], array['CO2 construction sechage_solaire 3', 'CO2 elec 6', 'CO2 construction sechage_solaire 2', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction sechage_solaire 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj50_ss)*(eh>10000)*(eh<100000)+(feobj100_ss)*(eh>100000))*tbentrant*d_vie', 'co2_e=feelec*welec', 'co2_c=((feobj50_ss)*(eh>10000)*(eh<100000)+(feobj100_ss)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj50_ss)*(eh>10000)*(eh<100000)+(feobj100_ss)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie']::varchar[],
formula_name varchar[] default array['CO2 construction sechage_solaire 3', 'CO2 elec 6', 'CO2 construction sechage_solaire 2', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction sechage_solaire 1']::varchar[],
siccite_e real,
d_vie real default 30::real,
eh real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('station_de_pompage', array['e', 'h', 'tauenterre', 'vu']::varchar[], array[]::varchar[], array['CO2 construction bassin_cylindrique 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('usine', array['d_vie', 'eh', 'welec', 'qe', 'dbo5', 'mes']::varchar[], array[]::varchar[], array['CO2 exploitation usine 1', 'CO2 exploitation usine 2', 'CO2 elec 6', 'CO2 construction usine 1', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction usine 2']::varchar[]) ;
...
formula varchar[] default array['co2_e=eh*fetraitement_e*nbjour*qe_eh', 'co2_e=fetraitement_e*nbjour*qe', 'co2_e=feelec*welec', 'co2_c=eh*fetraitement_c*nbjour*d_vie*qe_eh', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=fetraitement_c*nbjour*qe*d_vie']::varchar[],
formula_name varchar[] default array['CO2 exploitation usine 1', 'CO2 exploitation usine 2', 'CO2 elec 6', 'CO2 construction usine 1', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction usine 2']::varchar[],
d_vie real default 50::real,
eh real,
welec real,
qe real,
...
commit ; 
insert into ___.input_output values ('filiere_boue', array['d_vie', 'eh', 'welec', 'dbo5', 'mes']::varchar[], array['tbsortant_s']::varchar[], array['tbentrant filtre_a_presse 1', 'tbentrant digesteur_aerobie 2', 'CO2 elec 6']::varchar[]) ;
...
formula varchar[] default array['tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec']::varchar[],
formula_name varchar[] default array['tbentrant filtre_a_presse 1', 'tbentrant digesteur_aerobie 2', 'CO2 elec 6']::varchar[],
d_vie real default 15::real,
eh real,
welec real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('compostage', array['d_vie', 'eh', 'tbsortant', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction compostage 2', 'CO2 elec 6', 'CO2 exploitation compostage 3', 'CH4 exploitation compostage 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction compostage 3', 'CO2 exploitation compostage 3', 'N2O exploitation compostage 3', 'CO2 construction compostage 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=0.0005*fecompost*nbjour*(dbo5 + mes)', 'co2_e=feelec*welec', 'co2_e=fegazole*tbsortant*gazole_compost', 'ch4_e=tbsortant*ch4_compost', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=fecompost*tbentrant', 'co2_e=feelec*tbsortant*welec_compost', 'n2o_e=tbsortant*n2o_compost', 'co2_c=0.0005*eh*fecompost*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 construction compostage 2', 'CO2 elec 6', 'CO2 exploitation compostage 3', 'CH4 exploitation compostage 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction compostage 3', 'CO2 exploitation compostage 3', 'N2O exploitation compostage 3', 'CO2 construction compostage 1']::varchar[],
...
commit ; 
insert into ___.input_output values ('conditionnement_thermiqu', array['d_vie', 'eh', 'vboue', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 exploitation conditionnement_thermiqu 3', 'CO2 construction conditionnement_thermiqu 1', 'CO2 elec 6', 'CO2 construction conditionnement_thermiqu 2', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction conditionnement_thermiqu 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*vboue*welec_ct', 'co2_c=((feobj50_ct)*(eh>10000)*(eh<100000)+(feobj100_ct)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_e=feelec*welec', 'co2_c=((feobj50_ct)*(eh>10000)*(eh<100000)+(feobj100_ct)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj50_ct)*(eh>10000)*(eh<100000)+(feobj100_ct)*(eh>100000))*tbentrant*d_vie']::varchar[],
formula_name varchar[] default array['CO2 exploitation conditionnement_thermiqu 3', 'CO2 construction conditionnement_thermiqu 1', 'CO2 elec 6', 'CO2 construction conditionnement_thermiqu 2', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction conditionnement_thermiqu 3']::varchar[],
d_vie real default 15::real,
eh real,
vboue real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('digesteur_aerobie', array['d_vie', 'eh', 'tbsortant', 'tau_abattement', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction digesteur_aerobie 2', 'CO2 construction digesteur_aerobie 1', 'CO2 elec 6', 'CO2 construction digesteur_aerobie 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'tbsortant_s digesteur__methaniseur 3', 'CO2 exploitation digesteur_aerobie 3']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj10_da)*(eh<10000)+(feobj50_da)*(eh>10000)*(eh<100000)+(feobj100_da)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'co2_c=((feobj10_da)*(eh<10000)+(feobj50_da)*(eh>10000)*(eh<100000)+(feobj100_da)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_e=feelec*welec', 'co2_c=((feobj10_da)*(eh<10000)+(feobj50_da)*(eh>10000)*(eh<100000)+(feobj100_da)*(eh>100000))*tbentrant*d_vie', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'tbsortant_s=tbsortant*tau_abattement', 'co2_e=feelec*tbsortant*welec_da']::varchar[],
formula_name varchar[] default array['CO2 construction digesteur_aerobie 2', 'CO2 construction digesteur_aerobie 1', 'CO2 elec 6', 'CO2 construction digesteur_aerobie 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'tbsortant_s digesteur__methaniseur 3', 'CO2 exploitation digesteur_aerobie 3']::varchar[],
d_vie real default 30::real,
eh real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('rejets', array['eh', 'fech4_mil', 'abatdco', 'abatngl', 'fen2o_oxi', 'dco', 'ngl']::varchar[], array[]::varchar[], array['N2O exploitation rejets 1', 'CH4 exploitation rejets 1', 'N2O exploitation rejets 2', 'CH4 exploitation rejets 2']::varchar[]) ;
...
formula varchar[] default array['n2o_e=eh*fen2o_oxi*ntk_eh*(1 - abatngl)', 'ch4_e=eh*fech4_mil*dco_eh*(1 - abatdco)', 'n2o_e=fen2o_oxi*ngl', 'ch4_e=dco*fech4_mil']::varchar[],
formula_name varchar[] default array['N2O exploitation rejets 1', 'CH4 exploitation rejets 1', 'N2O exploitation rejets 2', 'CH4 exploitation rejets 2']::varchar[],
eh real,
...
commit ; 
insert into ___.input_output values ('degazage', array['prod_e', 'd_vie', 'e', 'eh', 'h', 'vit', 'tauenterre', 'abatdco', 'abatngl', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'qe', 'dco', 'ntk', 'dbo5', 'mes', 'vu', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation intrant degazage 6', 'CO2 construction degazage 2', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 construction degazage 1', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_co2l*(fetransp*transp_co2l + 1000*fe_co2l) + 0.001*q_coagl*(fetransp*transp_coagl + 1000*fe_coagl) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_fecl3*(fetransp*transp_fecl3 + 1000*fe_fecl3) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_javel*(fetransp*transp_javel + 1000*fe_javel) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_lait*(fetransp*transp_lait + 1000*fe_lait) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_c=(febet*cad*e*rhobet*(3.14159*h*vit*(e + 5.52791*(qe/vit)**0.5) + 24*qe) + 24.0*fepelle*tauenterre*vit*(h + e)*(0.3618*e + (qe/vit)**0.5)**2 + 24.0*cad*vit*(0.3618*e + (qe/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(cad*vit)', 'co2_e=feelec*welec', 'dco_s=eh*dco_eh*(1 - abatdco)', 'co2_c=(febet*cad*e*rhobet*(24*eh*qe_eh + 3.14159*h*vit*(e + 5.52791*(eh*qe_eh/vit)**0.5)) + 24.0*fepelle*tauenterre*vit*(h + e)*(0.3618*e + (eh*qe_eh/vit)**0.5)**2 + 24.0*cad*vit*(0.3618*e + (eh*qe_eh/vit)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(cad*vit)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=dco*(1 - abatdco)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (vu/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'ngl_s=ntk*(1 - abatngl)']::varchar[],
formula_name varchar[] default array['CO2 exploitation intrant degazage 6', 'CO2 construction degazage 2', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 construction degazage 1', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[],
prod_e ___.prod_e_type not null default 'Sulfate de sodium' references ___.prod_e_type_table(val),
d_vie real default 50::real,
e real default 0.25::real,
eh real,
...
commit ; 
insert into ___.input_output values ('stockage_boue', array['d_vie', 'aere', 'dbo', 'grand', 'eh', 'welec', 'festock', 'dbo5', 'mes', 'tbentrant']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction stockage_boue 2', 'CO2 construction stockage_boue 3', 'CO2 exploitation stockage_boue 1', 'CO2 elec 6', 'CO2 exploitation stockage_boue 2', 'CO2 exploitation stockage_boue 3', 'CO2 construction stockage_boue 1', 'CH4 exploitation stockage_boue 2', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=0.0005*festock*nbjour*d_vie*(dbo5 + mes)', 'co2_c=festock*tbentrant*d_vie', 'co2_e=0.0005*eh*fesilo_aere*nbjour*aere*(dbo5_eh + mes_eh)', 'co2_e=feelec*welec', 'co2_e=0.0005*fesilo_aere*nbjour*aere*(dbo5 + mes)', 'co2_e=fesilo_aere*tbentrant*aere', 'co2_c=0.0005*eh*festock*nbjour*d_vie*(dbo5_eh + mes_eh)', 'ch4_e=-dbo*(aere - 1)*(fesilo_grand*grand - fesilo_petit*(grand - 1))', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 construction stockage_boue 2', 'CO2 construction stockage_boue 3', 'CO2 exploitation stockage_boue 1', 'CO2 elec 6', 'CO2 exploitation stockage_boue 2', 'CO2 exploitation stockage_boue 3', 'CO2 construction stockage_boue 1', 'CH4 exploitation stockage_boue 2', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[],
d_vie real default 30::real,
...
commit ; 
insert into ___.input_output values ('lagunage', array['prod_e', 'd_vie', 'eh', 'abatdco', 'abatngl', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'dco', 'ntk', 'dbo5', 'mes', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_co2l*(fetransp*transp_co2l + 1000*fe_co2l) + 0.001*q_coagl*(fetransp*transp_coagl + 1000*fe_coagl) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_fecl3*(fetransp*transp_fecl3 + 1000*fe_fecl3) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_javel*(fetransp*transp_javel + 1000*fe_javel) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_lait*(fetransp*transp_lait + 1000*fe_lait) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'dco_s=eh*dco_eh*(1 - abatdco)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=dco*(1 - abatdco)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'ngl_s=ntk*(1 - abatngl)']::varchar[],
formula_name varchar[] default array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[],
prod_e ___.prod_e_type not null default 'Sulfate de sodium' references ___.prod_e_type_table(val),
d_vie real default 50::real,
eh real,
abatdco real,
...
commit ; 
insert into ___.input_output values ('grilles_degouttage', array['d_vie', 'transp_poly', 'q_poly', 'tbsortant', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 exploitation q_poly flottateur 6', 'CO2 construction grilles_degouttage 3', 'CO2 elec 6', 'CO2 construction grilles_degouttage 1', 'CO2 construction grilles_degouttage 2', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 exploitation grilles_degouttage 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_ge)*(eh<10000)+(feobj50_ge)*(eh>10000)*(eh<100000)+(feobj100_ge)*(eh>100000))*tbentrant*d_vie', 'co2_e=feelec*welec', 'co2_c=((feobj10_ge)*(eh<10000)+(feobj50_ge)*(eh>10000)*(eh<100000)+(feobj100_ge)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_c=((feobj10_ge)*(eh<10000)+(feobj50_ge)*(eh>10000)*(eh<100000)+(feobj100_ge)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=feelec*tbsortant*welec_ge']::varchar[],
formula_name varchar[] default array['CO2 exploitation q_poly flottateur 6', 'CO2 construction grilles_degouttage 3', 'CO2 elec 6', 'CO2 construction grilles_degouttage 1', 'CO2 construction grilles_degouttage 2', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 exploitation grilles_degouttage 3']::varchar[],
d_vie real default 15::real,
transp_poly real default 50::real,
q_poly real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('filtre_a_presse', array['d_vie', 'transp_fecl3', 'transp_chaux', 'q_poly', 'q_fecl3', 'transp_poly', 'q_chaux', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 elec 6', 'CO2 construction filtre_a_presse 2', 'CO2 exploitation intrant filtre_a_presse 6', 'CO2 construction filtre_a_presse 1', 'CO2 construction filtre_a_presse 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*welec', 'co2_c=((feobj10_fp)*(eh<10000)+(feobj50_fp)*(eh>10000)*(eh<100000)+(feobj100_fp)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'co2_e=fepolymere*q_poly + 0.001*fetransp*q_poly*transp_poly + 0.001*q_chaux*(1000*fechaux + fetransp*transp_chaux) + 0.001*q_fecl3*(1000*fefecl3 + fetransp*transp_fecl3)', 'co2_c=((feobj10_fp)*(eh<10000)+(feobj50_fp)*(eh>10000)*(eh<100000)+(feobj100_fp)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_c=((feobj10_fp)*(eh<10000)+(feobj50_fp)*(eh>10000)*(eh<100000)+(feobj100_fp)*(eh>100000))*tbentrant*d_vie', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 elec 6', 'CO2 construction filtre_a_presse 2', 'CO2 exploitation intrant filtre_a_presse 6', 'CO2 construction filtre_a_presse 1', 'CO2 construction filtre_a_presse 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[],
d_vie real default 15::real,
transp_fecl3 real,
transp_chaux real,
q_poly real,
...
commit ; 
insert into ___.input_output values ('flottateur', array['d_vie', 'tbsortant', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction flottateur 1', 'CO2 exploitation q_poly flottateur 6', 'CO2 elec 6', 'CO2 construction flottateur 3', 'CO2 exploitation flottateur 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction flottateur 2']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj10_flot)*(eh<10000)+(feobj50_flot)*(eh>10000)*(eh<100000)+(feobj100_flot)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_e=feelec*welec', 'co2_c=((feobj10_flot)*(eh<10000)+(feobj50_flot)*(eh>10000)*(eh<100000)+(feobj100_flot)*(eh>100000))*tbentrant*d_vie', 'co2_e=feelec*tbsortant*welec_flot', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_flot)*(eh<10000)+(feobj50_flot)*(eh>10000)*(eh<100000)+(feobj100_flot)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie']::varchar[],
formula_name varchar[] default array['CO2 construction flottateur 1', 'CO2 exploitation q_poly flottateur 6', 'CO2 elec 6', 'CO2 construction flottateur 3', 'CO2 exploitation flottateur 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction flottateur 2']::varchar[],
d_vie real default 30::real,
tbsortant real,
transp_poly real default 50::real,
q_poly real,
...
commit ; 
insert into ___.input_output values ('epaississement_statique', array['d_vie', 'eh', 'tbsortant', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 elec 6', 'CO2 construction epaississement_statique 1', 'CO2 construction epaississement_statique 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 exploitation epaississement_statique 3', 'CO2 construction epaississement_statique 2']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*welec', 'co2_c=((feobj10_es)*(eh<10000)+(feobj50_es)*(eh>10000)*(eh<100000)+(feobj100_es)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_c=((feobj10_es)*(eh<10000)+(feobj50_es)*(eh>10000)*(eh<100000)+(feobj100_es)*(eh>100000))*tbentrant*d_vie', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_e=feelec*tbsortant*welec_es', 'co2_c=((feobj10_es)*(eh<10000)+(feobj50_es)*(eh>10000)*(eh<100000)+(feobj100_es)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie']::varchar[],
formula_name varchar[] default array['CO2 elec 6', 'CO2 construction epaississement_statique 1', 'CO2 construction epaississement_statique 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 exploitation epaississement_statique 3', 'CO2 construction epaississement_statique 2']::varchar[],
d_vie real default 30::real,
eh real,
tbsortant real,
dbo5 real,
...
commit ; 
insert into ___.input_output values ('bassin_cylindrique', array['e', 'h', 'tauenterre', 'vu']::varchar[], array[]::varchar[], array['CO2 construction bassin_cylindrique 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('sechage_thermique', array['siccite_e', 'd_vie', 'eh', 'tbsortant', 'pelletisation', 'dbo5', 'mes', 'tbentrant', 'tee', 'welec']::varchar[], array['siccite_s', 'tbsortant_s']::varchar[], array['CO2 elec 6', 'CO2 exploitation sechage_thermique 3', 'CO2 construction sechage_thermique 1', 'CO2 construction sechage_thermique 3', 'CO2 construction sechage_thermique 2', 'CO2 exploitation sechage_thermique 4', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*welec', 'co2_e=feelec*tbsortant*(24*nbjour*pth*(siccite_e - siccite_s) - welec_st_nopell*(pelletisation - 1) + welec_st_pell*pelletisation)', 'co2_c=((feobj50_st)*(eh>10000)*(eh<100000)+(feobj100_st)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_c=((feobj50_st)*(eh>10000)*(eh<100000)+(feobj100_st)*(eh>100000))*tbentrant*d_vie', 'co2_c=((feobj50_st)*(eh>10000)*(eh<100000)+(feobj100_st)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'co2_e=feelec*(24*nbjour*pth*tee - tbsortant*(welec_st_nopell*(pelletisation - 1) - welec_st_pell*pelletisation))', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 elec 6', 'CO2 exploitation sechage_thermique 3', 'CO2 construction sechage_thermique 1', 'CO2 construction sechage_thermique 3', 'CO2 construction sechage_thermique 2', 'CO2 exploitation sechage_thermique 4', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[],
siccite_e real,
d_vie real default 15::real,
eh real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('chateau_deau', array['vbet', 'mpompe']::varchar[], array[]::varchar[], array['CO2 construction chateau_deau 5']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('conditionnement_chimique', array['d_vie', 'vboue', 'transp_fecl3', 'q_anio', 'transp_anio', 'q_catio', 'transp_chaux', 'transp_catio', 'q_fecl3', 'q_chaux', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction conditionnement_chimique 2', 'CO2 exploitation conditionnement_chimique 3', 'CO2 elec 6', 'CO2 construction conditionnement_chimique 3', 'CO2 exploitation intrant conditionnement_chimique 6', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction conditionnement_chimique 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj10_cc)*(eh<10000)+(feobj50_cc)*(eh>10000)*(eh<100000)+(feobj100_cc)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'co2_e=feelec*vboue*welec_cc', 'co2_e=feelec*welec', 'co2_c=((feobj10_cc)*(eh<10000)+(feobj50_cc)*(eh>10000)*(eh<100000)+(feobj100_cc)*(eh>100000))*tbentrant*d_vie', 'co2_e=0.001*q_anio*(1000*feanionique + fetransp*transp_anio) + 0.001*q_catio*(1000*fecationique + fetransp*transp_catio) + 0.001*q_chaux*(1000*fechaux + fetransp*transp_chaux) + 0.001*q_fecl3*(1000*fefecl3 + fetransp*transp_fecl3)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_cc)*(eh<10000)+(feobj50_cc)*(eh>10000)*(eh<100000)+(feobj100_cc)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie']::varchar[],
formula_name varchar[] default array['CO2 construction conditionnement_chimique 2', 'CO2 exploitation conditionnement_chimique 3', 'CO2 elec 6', 'CO2 construction conditionnement_chimique 3', 'CO2 exploitation intrant conditionnement_chimique 6', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction conditionnement_chimique 1']::varchar[],
d_vie real default 15::real,
vboue real,
transp_fecl3 real,
q_anio real,
...
commit ; 
insert into ___.input_output values ('centrifugeuse_pour_epais', array['d_vie', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 exploitation q_poly flottateur 6', 'CO2 construction centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction centrifugeuse_pour_epais 1', 'tbentrant digesteur_aerobie 2', 'CO2 construction centrifugeuse_pour_epais 3', 'tbentrant filtre_a_presse 1']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_ce)*(eh<10000)+(feobj50_ce)*(eh>10000)*(eh<100000)+(feobj100_ce)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'co2_e=feelec*welec', 'co2_c=((feobj10_ce)*(eh<10000)+(feobj50_ce)*(eh>10000)*(eh<100000)+(feobj100_ce)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'co2_c=((feobj10_ce)*(eh<10000)+(feobj50_ce)*(eh>10000)*(eh<100000)+(feobj100_ce)*(eh>100000))*tbentrant*d_vie', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 exploitation q_poly flottateur 6', 'CO2 construction centrifugeuse_pour_epais 2', 'CO2 elec 6', 'CO2 construction centrifugeuse_pour_epais 1', 'tbentrant digesteur_aerobie 2', 'CO2 construction centrifugeuse_pour_epais 3', 'tbentrant filtre_a_presse 1']::varchar[],
d_vie real default 15::real,
transp_poly real default 50::real,
q_poly real,
eh real,
...
commit ; 
insert into ___.input_output values ('chaulage', array['d_vie', 'eh', 'dbo5', 'mes', 'tbentrant', 'transp_chaux', 'q_chaux', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 elec 6', 'CO2 exploitation q_chaux chaulage 6', 'CO2 construction chaulage 1', 'CO2 construction chaulage 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction chaulage 2']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*welec', 'co2_e=0.001*q_chaux*(1000*fechaux + fetransp*transp_chaux)', 'co2_c=((feobj10_ch)*(eh<10000)+(feobj50_ch)*(eh>10000)*(eh<100000)+(feobj100_ch)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_c=((feobj10_ch)*(eh<10000)+(feobj50_ch)*(eh>10000)*(eh<100000)+(feobj100_ch)*(eh>100000))*tbentrant*d_vie', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_ch)*(eh<10000)+(feobj50_ch)*(eh>10000)*(eh<100000)+(feobj100_ch)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie']::varchar[],
formula_name varchar[] default array['CO2 elec 6', 'CO2 exploitation q_chaux chaulage 6', 'CO2 construction chaulage 1', 'CO2 construction chaulage 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction chaulage 2']::varchar[],
d_vie real default 15::real,
eh real,
dbo5 real,
mes real,
...
commit ; 
insert into ___.input_output values ('clarificateur', array['prod_e', 'd_vie', 'e', 'eh', 'h', 'taur', 'vit', 'tauenterre', 'abatdco', 'abatngl', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'qe', 'dco', 'ntk', 'dbo5', 'mes', 'vu', 'welec']::varchar[], array['tbentrant_s', 'ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 construction clarificateur 1', 'CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 construction clarificateur 2', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;
...
formula_name varchar[] default array['CO2 construction clarificateur 1', 'CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 construction clarificateur 2', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[],
prod_e ___.prod_e_type not null default 'Sulfate de sodium' references ___.prod_e_type_table(val),
d_vie real default 50::real,
e real default 0.25::real,
eh real,
...
commit ; 
insert into ___.input_output values ('digesteur__methaniseur', array['d_vie', 'tbsortant', 'tau_abattement', 'eh', 'dbo5', 'mes', 'vbiogaz', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 elec 6', 'CO2 construction digesteur__methaniseur 4', 'tbentrant digesteur_aerobie 2', 'CH4 exploitation digesteur__methaniseur 3', 'tbentrant filtre_a_presse 1', 'tbsortant_s digesteur__methaniseur 3', 'CO2 exploitation digesteur__methaniseur 3', 'CO2 construction digesteur__methaniseur 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=feelec*welec', 'co2_c=feobj_dan*vbiogaz', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'ch4_e=tbsortant*tau_fuite*vol_ms', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'tbsortant_s=tbsortant*tau_abattement', 'co2_e=feelec*tbsortant*welec_dan', 'co2_c=225*feobj_dan*tbsortant']::varchar[],
formula_name varchar[] default array['CO2 elec 6', 'CO2 construction digesteur__methaniseur 4', 'tbentrant digesteur_aerobie 2', 'CH4 exploitation digesteur__methaniseur 3', 'tbentrant filtre_a_presse 1', 'tbsortant_s digesteur__methaniseur 3', 'CO2 exploitation digesteur__methaniseur 3', 'CO2 construction digesteur__methaniseur 3']::varchar[],
d_vie real default 30::real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('filiere_eau', array['prod_e', 'd_vie', 'eh', 'abatdco', 'abatngl', 'dbo5elim', 'methode', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dco', 'ntk', 'dbo5', 'mes', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 exploitation filiere_eau 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'ngl_s bassin_biologique 3', 'ngl_s bassin_biologique 3']::varchar[]) ;

create sequence ___.filiere_eau_bloc_name_seq ;     

create type ___.methode_type as enum ('MBBR', 'BRM', 'SBR', 'Boues activées', 'Biofiltres');
...
formula varchar[] default array['co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_co2l*(fetransp*transp_co2l + 1000*fe_co2l) + 0.001*q_coagl*(fetransp*transp_coagl + 1000*fe_coagl) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_fecl3*(fetransp*transp_fecl3 + 1000*fe_fecl3) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_javel*(fetransp*transp_javel + 1000*fe_javel) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_lait*(fetransp*transp_lait + 1000*fe_lait) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'dco_s=eh*dco_eh*(1 - abatdco)', 'co2_e=feelec*dbo5elim*methode', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=dco*(1 - abatdco)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'ngl_s=ntk*(1 - abatngl)']::varchar[],
formula_name varchar[] default array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'CO2 exploitation filiere_eau 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'ngl_s bassin_biologique 3', 'ngl_s bassin_biologique 3']::varchar[],
prod_e ___.prod_e_type not null default 'Sulfate de sodium' references ___.prod_e_type_table(val),
d_vie real default 50::real,
eh real,
abatdco real,
...
commit ; 
insert into ___.input_output values ('brm', array['prod_e', 'd_vie', 'e', 'h', 'tauenterre', 'vu', 'eh', 'abatdco', 'abatngl', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'dco', 'ntk', 'dbo5', 'mes', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_anio*(fetransp*transp_anio + 1000*fe_anio) + 0.001*q_anti_mousse*(fetransp*transp_anti_mousse + 1000*fe_anti_mousse) + 0.001*q_antiscalant*(fetransp*transp_antiscalant + 1000*fe_antiscalant) + 0.001*q_ca_neuf*(fetransp*transp_ca_neuf + 1000*fe_ca_neuf) + 0.001*q_ca_poudre*(fetransp*transp_ca_poudre + 1000*fe_ca_poudre) + 0.001*q_ca_regen*(fetransp*transp_ca_regen + 1000*fe_ca_regen) + 0.001*q_caco3*(fetransp*transp_caco3 + 1000*fe_caco3) + 0.001*q_catio*(fetransp*transp_catio + 1000*fe_catio) + 0.001*q_chaux*(fetransp*transp_chaux + 1000*fe_chaux) + 0.001*q_citrique*(fetransp*transp_citrique + 1000*fe_citrique) + 0.001*q_cl2*(fetransp*transp_cl2 + 1000*fe_cl2) + 0.001*q_co2l*(fetransp*transp_co2l + 1000*fe_co2l) + 0.001*q_coagl*(fetransp*transp_coagl + 1000*fe_coagl) + 0.001*q_ethanol*(fetransp*transp_ethanol + 1000*fe_ethanol) + 0.001*q_fecl3*(fetransp*transp_fecl3 + 1000*fe_fecl3) + 0.001*q_h2o2*(fetransp*transp_h2o2 + 1000*fe_h2o2) + 0.001*q_hcl*(fetransp*transp_hcl + 1000*fe_hcl) + 0.001*q_javel*(fetransp*transp_javel + 1000*fe_javel) + 0.001*q_kmno4*(fetransp*transp_kmno4 + 1000*fe_kmno4) + 0.001*q_lait*(fetransp*transp_lait + 1000*fe_lait) + 0.001*q_mhetanol*(fetransp*transp_mhetanol + 1000*fe_mhetanol) + 0.001*q_naclo3*(fetransp*transp_naclo3 + 1000*fe_naclo3) + 0.001*q_nahso3*(fetransp*transp_nahso3 + 1000*fe_nahso3) + 0.001*q_nitrique*(fetransp*transp_nitrique + 1000*fe_nitrique) + 0.001*q_oxyl*(fetransp*transp_oxyl + 1000*fe_oxyl) + 0.001*q_phosphorique*(fetransp*transp_phosphorique + 1000*fe_phosphorique) + 0.001*q_poly*(fetransp*transp_poly + 1000*fe_poly) + 0.001*q_rei*(fetransp*transp_rei + 1000*fe_rei) + 0.001*q_sable_t*(fetransp*transp_sable_t + 1000*fe_sable_t) + 0.001*q_soude*(fetransp*transp_soude + 1000*fe_soude) + 0.001*q_soude_c*(fetransp*transp_soude_c + 1000*fe_soude_c) + 0.001*q_sulf*(fetransp*transp_sulf + 1000*fe_sulf) + 0.001*q_sulf_alu*(fetransp*transp_sulf_alu + 1000*fe_sulf_alu) + 0.001*q_sulf_sod*(fetransp*transp_sulf_sod + 1000*fe_sulf_sod) + 0.001*q_uree*(fetransp*transp_uree + 1000*fe_uree)', 'co2_e=feelec*welec', 'dco_s=eh*dco_eh*(1 - abatdco)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'dco_s=dco*(1 - abatdco)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=(febet*cad*e*rhobet*(3.14159*h**2*(e + 5.52791*(vu/h)**0.5) + 24*vu) + 24.0*fepelle*h*tauenterre*(h + e)*(0.3618*e + (vu/h)**0.5)**2 + 24.0*h*cad*(0.3618*e + (vu/h)**0.5)**2*(feevac*rhoterre*tauenterre*(h + e) + fefonda))/(h*cad)', 'ngl_s=eh*ntk_eh*(1 - abatngl)', 'co2_e=feelec*dbo5elim*w_dbo5_eau', 'ngl_s=ntk*(1 - abatngl)']::varchar[],
formula_name varchar[] default array['CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[],
prod_e ___.prod_e_type not null default 'Sulfate de sodium' references ___.prod_e_type_table(val),
d_vie real default 50::real,
e real default 0.25::real,
h real default 4::real,
...
commit ; 
insert into ___.input_output values ('bassin_dorage', array['prod_e', 'd_vie', 'e', 'eh', 'h', 'tsejour', 'tauenterre', 'abatdco', 'abatngl', 'q_ethanol', 'transp_lait', 'q_kmno4', 'q_soude', 'transp_ethanol', 'transp_ca_poudre', 'q_nitrique', 'transp_chaux', 'q_nahso3', 'q_sable_t', 'transp_hcl', 'transp_fecl3', 'q_mhetanol', 'q_phosphorique', 'q_hcl', 'q_co2l', 'q_rei', 'transp_anti_mousse', 'q_naclo3', 'q_uree', 'q_anti_mousse', 'transp_nahso3', 'transp_poly', 'q_chaux', 'transp_nitrique', 'transp_phosphorique', 'q_cl2', 'transp_ca_regen', 'q_antiscalant', 'transp_javel', 'q_lait', 'q_poly', 'q_fecl3', 'q_sulf', 'transp_naclo3', 'q_citrique', 'transp_uree', 'transp_citrique', 'transp_antiscalant', 'transp_oxyl', 'transp_kmno4', 'transp_sulf_alu', 'transp_coagl', 'transp_soude', 'q_sulf_sod', 'q_anio', 'q_sulf_alu', 'transp_sable_t', 'q_ca_regen', 'q_h2o2', 'transp_caco3', 'q_ca_poudre', 'q_ca_neuf', 'q_oxyl', 'transp_sulf', 'transp_soude_c', 'transp_rei', 'transp_cl2', 'transp_ca_neuf', 'q_soude_c', 'transp_h2o2', 'transp_catio', 'transp_co2l', 'transp_mhetanol', 'q_coagl', 'transp_anio', 'transp_sulf_sod', 'q_catio', 'q_javel', 'q_caco3', 'dbo5elim', 'w_dbo5_eau', 'qe', 'dco', 'ntk', 'dbo5', 'mes', 'vu', 'welec']::varchar[], array['ngl_s', 'dco_s', 'qe_s']::varchar[], array['CO2 construction bassin_dorage 1', 'CO2 exploitation intrant degazage 6', 'CO2 elec 6', 'dco_s clarificateur 3', 'tbentrant digesteur_aerobie 2', 'dco_s clarificateur 3', 'tbentrant filtre_a_presse 1', 'CO2 construction bassin_cylindrique 3', 'ngl_s bassin_biologique 3', 'CO2 construction bassin_dorage 2', 'CO2 exploitation fpr 3', 'ngl_s bassin_biologique 3']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('centrifugeuse_pour_deshy', array['d_vie', 'tbsortant', 'direct', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 exploitation q_poly flottateur 6', 'CO2 construction centrifugeuse_pour_deshy 3', 'CO2 elec 6', 'CO2 construction centrifugeuse_pour_deshy 1', 'CO2 exploitation centrifugeuse_pour_deshy 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction centrifugeuse_pour_deshy 2']::varchar[]) ;
...
formula varchar[] default array['co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_cd)*(eh<10000)+(feobj50_cd)*(eh>10000)*(eh<100000)+(feobj100_cd)*(eh>100000))*tbentrant*d_vie', 'co2_e=feelec*welec', 'co2_c=((feobj10_cd)*(eh<10000)+(feobj50_cd)*(eh>10000)*(eh<100000)+(feobj100_cd)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie', 'co2_e=feelec*tbsortant*(-welec_cd*direct + welec_cd + welec_direct*direct)', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_cd)*(eh<10000)+(feobj50_cd)*(eh>10000)*(eh<100000)+(feobj100_cd)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie']::varchar[],
formula_name varchar[] default array['CO2 exploitation q_poly flottateur 6', 'CO2 construction centrifugeuse_pour_deshy 3', 'CO2 elec 6', 'CO2 construction centrifugeuse_pour_deshy 1', 'CO2 exploitation centrifugeuse_pour_deshy 3', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction centrifugeuse_pour_deshy 2']::varchar[],
d_vie real default 15::real,
tbsortant real,
...
commit ; 
insert into ___.input_output values ('filtre_a_bande', array['d_vie', 'transp_poly', 'q_poly', 'eh', 'dbo5', 'mes', 'tbentrant', 'welec']::varchar[], array['tbsortant_s']::varchar[], array['CO2 construction filtre_a_bande 2', 'CO2 exploitation q_poly flottateur 6', 'CO2 construction filtre_a_bande 3', 'CO2 elec 6', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction filtre_a_bande 1']::varchar[]) ;
...
formula varchar[] default array['co2_c=((feobj10_fb)*(eh<10000)+(feobj50_fb)*(eh>10000)*(eh<100000)+(feobj100_fb)*(eh>100000))*((dbo5/2+mes/2)/1000*nbjour)*d_vie', 'co2_e=0.001*q_poly*(1000*fepolymere + fetransp*transp_poly)', 'co2_c=((feobj10_fb)*(eh<10000)+(feobj50_fb)*(eh>10000)*(eh<100000)+(feobj100_fb)*(eh>100000))*tbentrant*d_vie', 'co2_e=feelec*welec', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)', 'co2_c=((feobj10_fb)*(eh<10000)+(feobj50_fb)*(eh>10000)*(eh<100000)+(feobj100_fb)*(eh>100000))*(((dbo5_eh*eh)/2+(mes_eh*eh)/2)/1000*nbjour)*d_vie']::varchar[],
formula_name varchar[] default array['CO2 construction filtre_a_bande 2', 'CO2 exploitation q_poly flottateur 6', 'CO2 construction filtre_a_bande 3', 'CO2 elec 6', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1', 'CO2 construction filtre_a_bande 1']::varchar[],
d_vie real default 15::real,
transp_poly real default 50::real,
q_poly real,
eh real,
...
commit ; 
insert into ___.input_output values ('tamis', array['d_vie', 'eh', 'qmax', 'munite_tamis', 'compt', 'welec', 'qe', 'dbo5', 'mes']::varchar[], array['qe_s']::varchar[], array['CO2 exploitation tamis 1', 'CO2 elec 6', 'CO2 construction tamis 2', 'CO2 construction tamis 1', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[]) ;
...
formula varchar[] default array['co2_e=eh*fedechet*rhodechet*(compt*qdechet_tamis_comp - qdechet_tamis_ncomp*(compt - 1))', 'co2_e=feelec*welec', 'co2_c=fepoids*munite_tamis*qe/qmax', 'co2_c=eh*fepoids*munite_tamis*qe_eh/qmax', 'tbentrant=0.0005*nbjour*(dbo5 + mes)', 'tbentrant=0.0005*eh*nbjour*(dbo5_eh + mes_eh)']::varchar[],
formula_name varchar[] default array['CO2 exploitation tamis 1', 'CO2 elec 6', 'CO2 construction tamis 2', 'CO2 construction tamis 1', 'tbentrant digesteur_aerobie 2', 'tbentrant filtre_a_presse 1']::varchar[],
d_vie real default 15::real,
eh real,
