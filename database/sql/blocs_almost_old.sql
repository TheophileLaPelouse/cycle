...
commit ; 
insert into ___.input_output values ('dessableurdegraisseur', array['eh', 'vit', 'vu', 'e', 'cad', 'h', 'taur', 'tauenterre', 'lavage', 'cgraisses', 'csables', 'qe']::varchar[], array['qe_s']::varchar[], array['Bassin vitesse construction niveau 2', 'Bassin dimension construction niveau 3', 'sables et graisses exploitation niveau 1', 'Sables et graisses exploitation débit', 'sables et graisses exploitation niveau 3']::varchar[]) ;
...
formula varchar[] default array['co2_c = (febet*e*rhobet*(3.14159*h*vit*(e + 5.52791*(qe*(taur + 1)/vit)**0.5) + 24*qe*(taur + 1)) + 24.0*tauenterre*vit*(h + e)*(0.3618*e + (qe*(taur + 1)/vit)**0.5)**2*(feevac*rhoterre + fepelle*cad))/vit', 'co2_c =(febet*e*rhobet*(3.14159*h**2*(e + 1.12838*(vu/h)**0.5) + 1.0*vu) + 3.14159*h*tauenterre*(h + e)*(e + 0.56419*(vu/h)**0.5)**2*(feevac*rhoterre + fepelle*cad))/h', 'co2_e = eh*(432.0338 - 0.0221*lavage)', 'co2_e = qe*(7200.56333 - 0.36833*lavage)', 'co2_e = qe*(720.0*cgraisses + 216.66667*csables)']::varchar[],
formula_name varchar[] default array['Bassin vitesse construction niveau 2', 'Bassin dimension construction niveau 3', 'sables et graisses exploitation niveau 1', 'Sables et graisses exploitation débit', 'sables et graisses exploitation niveau 3']::varchar[],
eh real,
vit real default 20,
vu real,
e real default 0.25,
...
commit ; 
insert into ___.input_output values ('degrilleur', array['munite', 'eh', 'qe', 'gros', 'compd', 'qmax']::varchar[], array['qe_s']::varchar[], array['machine construction débit max niveau 1', 'machine construction débit max niveau 2', 'degrilleur exploitation niveau 1', 'degrilleur exploitation niveau 2', 'degrilleur exploitation niveau 3']::varchar[]) ;
...
formula_name varchar[] default array['machine construction débit max niveau 1', 'machine construction débit max niveau 2', 'degrilleur exploitation niveau 1', 'degrilleur exploitation niveau 2', 'degrilleur exploitation niveau 3']::varchar[],
munite real default 1500,
eh real,
qe real,
gros real,
compd real,
...
commit ; 
insert into ___.input_output values ('clarificateur', array['eh', 'vit', 'vu', 'e', 'cad', 'h', 'taur', 'tauenterre', 'qe']::varchar[], array['qe_s']::varchar[], array['Bassin vitesse construction niveau 1', 'Bassin vitesse construction niveau 2', 'Bassin dimension construction niveau 3']::varchar[]) ;
...
formula varchar[] default array['co2_c = (febet*e*rhobet*(2.88*eh*(taur + 1) + 3.14159*h*vit*(e + 1.91492*(eh*(taur + 1)/vit)**0.5)) + 3.14159*tauenterre*vit*(h + e)*(e + 0.95746*(eh*(taur + 1)/vit)**0.5)**2*(feevac*rhoterre + fepelle*cad))/vit', 'co2_c = (febet*e*rhobet*(3.14159*h*vit*(e + 5.52791*(qe*(taur + 1)/vit)**0.5) + 24*qe*(taur + 1)) + 24.0*tauenterre*vit*(h + e)*(0.3618*e + (qe*(taur + 1)/vit)**0.5)**2*(feevac*rhoterre + fepelle*cad))/vit', 'co2_c =(febet*e*rhobet*(3.14159*h**2*(e + 1.12838*(vu/h)**0.5) + 1.0*vu) + 3.14159*h*tauenterre*(h + e)*(e + 0.56419*(vu/h)**0.5)**2*(feevac*rhoterre + fepelle*cad))/h']::varchar[],
formula_name varchar[] default array['Bassin vitesse construction niveau 1', 'Bassin vitesse construction niveau 2', 'Bassin dimension construction niveau 3']::varchar[],
eh real,
vit real default 60,
vu real,
e real default 0.25,
...
commit ; 
insert into ___.input_output values ('bassin_biologique', array['eh', 'vu', 'e', 'cad', 'h', 'tauenterre', 'tsejour', 'qe']::varchar[], array['qe_s']::varchar[], array['Bassin vitesse construction niveau 1', 'Bassin vitesse construction niveau 2', 'Bassin dimension construction niveau 3', 'Bassin biologique construction niveau 1', 'Bassin biologique construction niveau 2']::varchar[]) ;
...
h real default 5,
tauenterre real default 0.75,
tsejour ___.tsejour_type not null default 'Faible charge' references ___.tsejour_type_table(val),
qe real,
qe_s real,
...
commit ; 
insert into ___.input_output values ('bassin_dorage', array['eh', 'vu', 'e', 'cad', 'h', 'taur', 'tauenterre', 'tjour', 'qe']::varchar[], array['qe_s']::varchar[], array['Bassin dimension construction niveau 3', 'bassin orage construction niveau 1', 'bassin orage construction niveau 2']::varchar[]) ;
...
commit ; 
insert into ___.input_output values ('decanteur_lamellaire', array['eh', 'e', 'cad', 'h', 'tauenterre', 'vit', 'vlam', 'long', 'larg', 'qe']::varchar[], array['qe_s']::varchar[], array['decanteur lamellaire construction niveau 1', 'decanteur lamellaire construction niveau 2', 'decanteur lamellaire construction niveau 3']::varchar[]) ;
...
formula_name varchar[] default array['decanteur lamellaire construction niveau 1', 'decanteur lamellaire construction niveau 2', 'decanteur lamellaire construction niveau 3']::varchar[],
eh real,
e real default 0.25,
cad real default 125,
h real default 5,
...
formula_name varchar[] default array['tamis statique construction niveau de détail 1', 'tamis statique construction niveau de détail 2', 'tamis exploitation niveau 1', 'tamis exploitation niveau 2', 'tamis exploitation niveau 3']::varchar[],
qe real,
...
commit ; 
insert into ___.input_output values ('digesteur', array['eh', 'tbentrant', 'mes', 'dbo5']::varchar[], array['tbsortant']::varchar[], array['digesteur construction niveau 1', 'digesteur construction niveau 2', 'digesteur construction niveau 3']::varchar[]) ;
...
formula varchar[] default array['co2_c = (0.0228*(eh<10000)+0.0126*(eh>10000)*(eh<100000)+0.0102*(eh>100000))*((0.06*eh)/2+(0.09*eh)/2)/1000', 'co2_c = (0.0228*(eh<10000)+0.0126*(eh>10000)*(eh<100000)+0.0102*(eh>100000))*(dbo5/2+mes/2)/1000', 'co2_c = (0.0228*(eh<10000)+0.0126*(eh>10000)*(eh<100000)+0.0102*(eh>100000))*tbentrant']::varchar[],
formula_name varchar[] default array['digesteur construction niveau 1', 'digesteur construction niveau 2', 'digesteur construction niveau 3']::varchar[],
eh real,
tbentrant real,
mes real,
dbo5 real,
...
ngl real,
dco real,
oxi ___.oxi_type not null default 'bien oxygéné' references ___.oxi_type_table(val),
...
commit ; 
insert into ___.input_output values ('table_degouttage', array['eh', 'dbo5', 'mes', 'tbentrant']::varchar[], array['tbentrant', 'tbsortant']::varchar[], array['table egouttage construction niveau 1', 'table egouttage construction niveau 2', 'table egouttage construction niveau 3']::varchar[]) ;
...
formula varchar[] default array['co2_c = (0.0044*(eh<10000)+0.0022*(eh>10000)*(eh<100000)+0.0018*(eh>100000))*((0.06*eh)/2+(0.09*eh)/2)/1000', 'co2_c = (0.0044*(eh<10000)+0.0022*(eh>10000)*(eh<100000)+0.0018*(eh>100000))*(dbo5/2+mes/2)/1000', 'co2_c = (0.0245*(eh<10000)+0.0109*(eh>10000)*(eh<100000)+0.0096*(eh>100000))*tbentrant']::varchar[],
formula_name varchar[] default array['table egouttage construction niveau 1', 'table egouttage construction niveau 2', 'table egouttage construction niveau 3']::varchar[],
eh real,
dbo5 real,
mes real,
tbentrant real,
...
formula varchar[] default array['co2_c = (0.1296*(eh<10000)+0.0759*(eh>10000)*(eh<100000)+0.1363*(eh>100000))*((0.06*eh)/2+(0.09*eh)/2)/1000', 'co2_c = (0.0245*(eh<10000)+0.0109*(eh>10000)*(eh<100000)+0.0096*(eh>100000))*(dbo5/2+mes/2)/1000', 'co2_c = (0.1296*(eh<10000)+0.0759*(eh>10000)*(eh<100000)+0.1363*(eh>100000))*tbentrant']::varchar[],
