...
<qgis hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyAlgorithm="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" version="3.34.9-Prizren" maxScale="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" labelsEnabled="0" minScale="100000000" readOnly="0">
  <flags>
  ...
  <temporal mode="0" fixedDuration="0" accumulate="0" endField="" endExpression="" durationUnit="min" startField="" durationField="id" limitMode="0" enabled="0" startExpression="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation clamping="Terrain" extrusion="0" symbology="Line" zoffset="0" respectLayerSymbol="1" zscale="1" extrusionEnabled="0" binding="Centroid" type="IndividualFeatures" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol force_rhr="0" clip_to_extent="1" is_animated="0" frame_rate="10" alpha="1" type="line" name="">
        ...
        <layer pass="0" locked="0" id="{7a10115f-3768-43b3-a337-55e034e3c05d}" class="SimpleLine" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol force_rhr="0" clip_to_extent="1" is_animated="0" frame_rate="10" alpha="1" type="fill" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer pass="0" locked="0" id="{22f2e028-4aa5-4f10-a20a-b8135890f6dc}" class="SimpleFill" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol force_rhr="0" clip_to_extent="1" is_animated="0" frame_rate="10" alpha="1" type="marker" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer pass="0" locked="0" id="{9cf84ed7-ca6f-43d9-a24a-aa72153db26e}" class="SimpleMarker" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" is_animated="0" frame_rate="10" alpha="1" type="fill" name="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer pass="0" locked="0" id="{901a91a3-34c4-4cd8-a857-73cd281cd640}" class="GradientFill" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
        ...
        <layer pass="0" locked="0" id="{263f0dfc-cd1e-4fa5-ad5a-281eda7da243}" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="247,247,247,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="0,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" clip_to_extent="1" is_animated="0" frame_rate="10" alpha="1" type="fill" name="">
        ...
        <layer pass="0" locked="0" id="{a5ae1fd9-1b53-4d08-854f-f337764cc99e}" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="0,0,255,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory direction="0" showAxis="1" spacingUnitScale="3x:0,0,0,0,0,0" spacing="5" enabled="0" sizeScale="3x:0,0,0,0,0,0" height="15" spacingUnit="MM" barWidth="5" width="15" sizeType="MM" penWidth="0" lineSizeScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" labelPlacementMethod="XHeight" diagramOrientation="Up" opacity="1" lineSizeType="MM" penAlpha="255" scaleDependency="Area" minimumSize="0" minScaleDenominator="0" backgroundAlpha="255" scaleBasedVisibility="0" backgroundColor="#ffffff" rotationOffset="270" penColor="#000000">
      <fontProperties style="" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" bold="0"/>
      <axisSymbol>
        <symbol force_rhr="0" clip_to_extent="1" is_animated="0" frame_rate="10" alpha="1" type="line" name="">
          <data_defined_properties>
            <Option type="Map">
          ...
          <layer pass="0" locked="0" id="{330792d7-115e-496a-a7e6-68e68d7b2bbf}" class="SimpleLine" enabled="1">
            <Option type="Map">
              <Option value="0" type="QString" name="align_dash_pattern"/>
              <Option value="square" type="QString" name="capstyle"/>
              <Option value="5;2" type="QString" name="customdash"/>
  ...
  <DiagramLayerSettings obstacle="0" zIndex="0" linePlacementFlags="18" priority="0" dist="0" showAll="1" placement="1">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="dbo5" index="3" name=""/>
    <alias field="q" index="4" name=""/>
    <alias field="eh" index="5" name=""/>
    <alias field="formula" index="6" name=""/>
    <alias field="sur_bloc" index="7" name=""/>
    <alias field="model" index="8" name=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" field="q" unique_strength="0" notnull_strength="0"/>
