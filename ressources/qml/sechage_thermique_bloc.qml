...
<qgis simplifyDrawingTol="1" simplifyMaxScale="1" symbologyReferenceScale="-1" maxScale="0" simplifyLocal="1" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" readOnly="0" minScale="100000000" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingHints="1" version="3.34.9-Prizren">
  ...
  <elevation zscale="1" extrusion="0" extrusionEnabled="0" respectLayerSymbol="1" clamping="Terrain" symbology="Line" binding="Centroid" type="IndividualFeatures" showMarkerSymbolInSurfacePlots="0" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" alpha="1" type="line" name="" is_animated="0" force_rhr="0" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" class="SimpleLine" enabled="1" id="{f5cbd00c-3e91-4430-85cb-375fe4bd93e8}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" alpha="1" type="fill" name="" is_animated="0" force_rhr="0" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" class="SimpleFill" enabled="1" id="{5eefeac3-42bf-471a-b6d2-db73ca7028c2}">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" alpha="1" type="marker" name="" is_animated="0" force_rhr="0" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" class="SimpleMarker" enabled="1" id="{12e904ca-0ac8-4a2c-9df3-73a2ec9bda3c}">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="singleSymbol" referencescale="-1" enableorderby="0">
    <symbols>
      <symbol frame_rate="10" alpha="1" type="marker" name="0" is_animated="0" force_rhr="0" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" class="SimpleMarker" enabled="1" id="{5e674166-4329-4937-bdfb-2f5ef3f14c64}">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="cap_style" value="square"/>
  ...
  <aliases>
    ...
    <alias index="11" name="Tonne de boue en amont de la filière (t/an)" field="tbentrant"/>
    ...
    <alias index="15" name="Tonne de boue sortant (t/an)" field="tbsortant_s"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="siccite_e"/>
    ...
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="pelletisation"/>
    ...
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="tee"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="welec"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="siccite_s"/>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" verticalStretch="0" type="Tab" name="Exploitation" groupBox="0" visibilityExpressionEnabled="0" columnCount="1" collapsed="0" collapsedExpression="" visibilityExpression="" horizontalStretch="0" showLabel="1">
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" verticalStretch="0" type="GroupBox" name="Etude de faisabilité" groupBox="1" visibilityExpressionEnabled="0" columnCount="1" collapsed="0" collapsedExpression="" visibilityExpression="" horizontalStretch="0" showLabel="1">
        ...
        <attributeEditorContainer collapsedExpressionEnabled="0" verticalStretch="0" type="GroupBox" name="Valeurs par défaut spécifiques" groupBox="1" visibilityExpressionEnabled="0" columnCount="1" collapsed="1" collapsedExpression="" visibilityExpression="" horizontalStretch="0" showLabel="1">
          ...
          <attributeEditorField index="8" verticalStretch="0" name="pelletisation" horizontalStretch="0" showLabel="1">
            <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
              <labelFont description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" italic="0" underline="0" bold="0" strikethrough="0"/>
            </labelStyle>
          </attributeEditorField>
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" verticalStretch="0" type="GroupBox" name="Conception très détaillée" groupBox="1" visibilityExpressionEnabled="0" columnCount="1" collapsed="0" collapsedExpression="" visibilityExpression="" horizontalStretch="0" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" italic="0" underline="0" bold="0" strikethrough="0"/>
        </labelStyle>
        <attributeEditorField index="12" verticalStretch="0" name="tee" horizontalStretch="0" showLabel="1">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" italic="0" underline="0" bold="0" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" verticalStretch="0" type="Tab" name="Sortie" groupBox="0" visibilityExpressionEnabled="0" columnCount="1" collapsed="0" collapsedExpression="" visibilityExpression="" horizontalStretch="0" showLabel="1">
      ...
      <attributeEditorField index="14" verticalStretch="0" name="siccite_s" horizontalStretch="0" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" italic="0" underline="0" bold="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
